...
class Audio {
    ...
    @:noCompletion public function destroy() {
        ...
        */
    public function create( _name:String, _file:String, ?_stream:Bool = false ) : Void {
        ...
        */
    public function sound( _name:String ) : Void {
        ...
        /**
            ...
            **returns** true/false
        */
    public function exists( _name:String ) : Void {
        ...
        /**
            ...
            **returns** true/false
        */
    public function playing( _name:String ) : Void {
    ...
    public function play( _name:String, ?_number_of_times:Int=1, ?_start_position_in_s:Float = 0 ) {
        ...
        */
    public function volume( _name:String, ?_volume:Float = null ) : Void {
        ...
        */
    public function pan( _name:String, ?_pan:Float = null ) : Void  {
        ...
        */
    public function position( _name:String, ?_pos:Float = null ) : Void {
