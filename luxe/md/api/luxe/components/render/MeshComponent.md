...
<h1>MeshComponent</h1>
<small>`luxe.components.render.MeshComponent` defined in ``</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">mesh : [luxe.Mesh](../../../../api/luxe/Mesh.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="options"><a class="lift" href="#options">options</a></a><div class="clear"></div>
                <code class="signature apipage">options : [luxe.options.MeshOptions](../../../../api/luxe/options/MeshOptions.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<span class="method apipage">
            <a name="entity_pos_change"><a class="lift" href="#entity_pos_change">entity\_pos\_change</a></a><a data-tooltip="inherited from <a href='../../../../api/luxe/Component.html#entity\_pos\_change'>luxe.Component</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">entity\_pos\_change(\_pos:[luxe.Vector](../../../../api/luxe/Vector.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="entity_rotation_change"><a class="lift" href="#entity_rotation_change">entity\_rotation\_change</a></a><a data-tooltip="inherited from <a href='../../../../api/luxe/Component.html#entity\_rotation\_change'>luxe.Component</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">entity\_rotation\_change(\_rotation:[luxe.Quaternion](../../../../api/luxe/Quaternion.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="entity_scale_change"><a class="lift" href="#entity_scale_change">entity\_scale\_change</a></a><a data-tooltip="inherited from <a href='../../../../api/luxe/Component.html#entity\_scale\_change'>luxe.Component</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">entity\_scale\_change(\_scale:[luxe.Vector](../../../../api/luxe/Vector.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_options:[luxe.options.MeshOptions](../../../../api/luxe/options/MeshOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
