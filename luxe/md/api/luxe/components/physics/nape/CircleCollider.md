...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_options:[luxe.components.physics.nape.CircleColliderOptions](../../../../../api/luxe/components/physics/nape/CircleColliderOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
