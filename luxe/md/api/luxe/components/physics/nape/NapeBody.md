...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="body"><a class="lift" href="#body">body</a></a><div class="clear"></div>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_options:[luxe.components.physics.nape.NapeBodyOptions](../../../../../api/luxe/components/physics/nape/NapeBodyOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
