...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_options:[luxe.components.physics.nape.BoxColliderOptions](../../../../../api/luxe/components/physics/nape/BoxColliderOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
