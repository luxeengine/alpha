...
<h1>ColorHSL</h1>
<small>`luxe.ColorHSL` defined in `luxe.Color`</small>



<hr/>

`typedef`&nbsp;alias of `phoenix.ColorHSL`   
...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                ...
                <code class="signature apipage">l : [Float](http://api.haxe.org/Float.html)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">\_refresh() : [phoenix.ColorHSL](../../api/phoenix/ColorHSL.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="clone"><a class="lift" href="#clone">clone</a></a><div class="clear"></div>
            <code class="signature apipage">clone() : [phoenix.ColorHSL](../../api/phoenix/ColorHSL.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="fromColor"><a class="lift" href="#fromColor">fromColor</a></a><div class="clear"></div>
            <code class="signature apipage">fromColor(\_color:[phoenix.Color](../../api/phoenix/Color.html)<span></span>) : [phoenix.ColorHSL](../../api/phoenix/ColorHSL.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_h:[Float](http://api.haxe.org/Float.html)<span></span>, \_s:[Float](http://api.haxe.org/Float.html)<span></span>, \_l:[Float](http://api.haxe.org/Float.html)<span></span>, \_a:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="set"><a class="lift" href="#set">set</a></a><div class="clear"></div>
            <code class="signature apipage">set(\_h:[Float](http://api.haxe.org/Float.html)<span></span>, \_s:[Float](http://api.haxe.org/Float.html)<span></span>, \_l:[Float](http://api.haxe.org/Float.html)<span></span>, \_a:[Float](http://api.haxe.org/Float.html)<span></span>) : [phoenix.ColorHSL](../../api/phoenix/ColorHSL.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">tween(\_time\_in\_seconds:[Float](http://api.haxe.org/Float.html)<span></span>, \_dest:[luxe.options.ColorOptions](../../api/luxe/options/ColorOptions.html)<span></span>, \_override:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [luxe.tween.actuators.IGenericActuator](../../api/luxe/tween/actuators/IGenericActuator.html)</code><br/><span class="small_desc_flat"></span>
