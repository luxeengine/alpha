...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_h:[Float](http://api.haxe.org/Float.html)<span>=0.0f</span>, \_s:[Float](http://api.haxe.org/Float.html)<span>=1.0f</span>, \_l:[Float](http://api.haxe.org/Float.html)<span>=1.0f</span>, \_a:[Float](http://api.haxe.org/Float.html)<span>=1.0f</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="set"><a class="lift" href="#set">set</a></a><div class="clear"></div>
            <code class="signature apipage">set(\_h:[Float](http://api.haxe.org/Float.html)<span>=null</span>, \_s:[Float](http://api.haxe.org/Float.html)<span>=null</span>, \_l:[Float](http://api.haxe.org/Float.html)<span>=null</span>, \_a:[Float](http://api.haxe.org/Float.html)<span>=null</span>) : [phoenix.ColorHSL](../../api/phoenix/ColorHSL.html)</code><br/><span class="small_desc_flat"></span>
