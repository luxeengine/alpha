...
<h3>Values</h3> <hr/><span class="member signature apipage">
            <a name="fit"><a class="lift" href="#fit">fit</a></a>
        </span>
        <span class="small_desc_flat"> fit the size into the camera viewport (possible letter/pillar box) </span><span class="member signature apipage">
            <a name="cover"><a class="lift" href="#cover">cover</a></a>
        </span>
        <span class="small_desc_flat"> cover the viewport with the size (possible cropping) </span><span class="member signature apipage">
            <a name="contain"><a class="lift" href="#contain">contain</a></a>
        </span>
        <span class="small_desc_flat"> contain the size (stretch to fit the viewport) </span>
