...
<span class="method apipage">
            ...
            <code class="signature apipage">new(end:[Float](http://api.haxe.org/Float.html)<span></span>, strength:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
