...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="addPath"><a class="lift" href="#addPath">addPath</a></a><div class="clear"></div>
            <code class="signature apipage">addPath(path:[luxe.tween.BezierPath](../../../api/luxe/tween/BezierPath.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
