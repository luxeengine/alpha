...
<h1>BackEaseIn</h1>
<small>`luxe.tween.easing.BackEaseIn`</small>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(s:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
