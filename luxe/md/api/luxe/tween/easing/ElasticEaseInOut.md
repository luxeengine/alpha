...
<h1>ElasticEaseInOut</h1>
<small>`luxe.tween.easing.ElasticEaseInOut`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">p : [Float](http://api.haxe.org/Float.html)</code><br/></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(a:[Float](http://api.haxe.org/Float.html)<span></span>, p:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
