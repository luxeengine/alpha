...
<span class="method apipage">
            ...
            <code class="signature apipage">line(x:[Float](http://api.haxe.org/Float.html)<span></span>, y:[Float](http://api.haxe.org/Float.html)<span></span>, strength:[Float](http://api.haxe.org/Float.html)<span></span>) : [luxe.tween.MotionPath](../../../api/luxe/tween/MotionPath.html)</code><br/><span class="small_desc_flat">Adds a line to the current motion path   
