...
<span class="method apipage">
            ...
            <code class="signature apipage">onprogress(\_state:[luxe.ParcelChange](../../api/luxe/ParcelChange.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
