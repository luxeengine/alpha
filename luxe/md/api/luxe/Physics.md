...
<h3>Properties</h3> <hr/><span class="member apipage">
                <a name="step_rate"><a class="lift" href="#step_rate">step\_rate</a></a><div class="clear"></div>
                <code class="signature apipage">step\_rate : [Float](http://api.haxe.org/Float.html)</code><br/></span>
            <span class="small_desc_flat"></span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="add_engine"><a class="lift" href="#add_engine">add\_engine</a></a><div class="clear"></div>
            <code class="signature apipage">add\_engine&lt;T1&gt;, T2&gt;(type:[Class](http://api.haxe.org/Class.html)&lt;[add_engine.T1](#)&gt;<span></span>, \_data:[add_engine.T2](#)<span></span>) : [add_engine.T1](#)</code><br/><span class="small_desc_flat">Add a physics engine type to be run by this class.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">emit(\_event:[luxe.PhysicsEvent](../../api/luxe/PhysicsEvent.html)<span></span>, \_float:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_core:[luxe.Engine](../../api/luxe/Engine.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="off"><a class="lift" href="#off">off</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">off(\_event:[luxe.PhysicsEvent](../../api/luxe/PhysicsEvent.html)<span></span>, \_handler:[Float](http://api.haxe.org/Float.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="on"><a class="lift" href="#on">on</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">on(\_event:[luxe.PhysicsEvent](../../api/luxe/PhysicsEvent.html)<span></span>, \_handler:[Float](http://api.haxe.org/Float.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">update() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Only call this manually if step_rate is 0!</span>
