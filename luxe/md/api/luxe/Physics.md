...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">add\_engine&lt;T1&gt;, T2&gt;(type:[Class](#)&lt;[add_engine.T1](#)&gt;<span></span>, \_data:[add_engine.T2](#)<span></span>) : [add_engine.T1](#)</code><br/><span class="small_desc_flat">Add a physics engine type to be run by this class.</span>
