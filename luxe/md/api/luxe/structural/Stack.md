...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">iterator() : [Iterator](http://api.haxe.org/Iterator.html)&lt;[luxe.structural.Stack.T](../../../api/luxe/structural/Stack/T.html)&gt;</code><br/><span class="small_desc_flat">create an iterator for the stack. Usable as `for(item in stack)`</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">pop() : [Null](http://api.haxe.org/Null.html)&lt;[luxe.structural.Stack.T](../../../api/luxe/structural/Stack/T.html)&gt;</code><br/><span class="small_desc_flat">Pop the back item off the stack. If the queue is empty, returns null</span>


</span>
<span class="method apipage">
            <a name="push"><a class="lift" href="#push">push</a></a><div class="clear"></div>
            <code class="signature apipage">push(node:[Null](http://api.haxe.org/Null.html)&lt;[luxe.structural.Stack.T](../../../api/luxe/structural/Stack/T.html)&gt;<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Push a node onto the back of the queue. node cannot be null</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">top() : [Null](http://api.haxe.org/Null.html)&lt;[luxe.structural.Stack.T](../../../api/luxe/structural/Stack/T.html)&gt;</code><br/><span class="small_desc_flat">Return the top item of the stack, or null if empty</span>
