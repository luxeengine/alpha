...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="black"><a class="lift" href="#black">black</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">black : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="red"><a class="lift" href="#red">red</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">red : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
