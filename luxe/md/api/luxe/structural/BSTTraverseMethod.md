...
<small>`luxe.structural.BSTTraverseMethod`</small>
...
<h3>Values</h3> <hr/><span class="member signature apipage">
            <a name="order_pre"><a class="lift" href="#order_pre">order\_pre</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="order_retain"><a class="lift" href="#order_retain">order\_retain</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="order_post"><a class="lift" href="#order_post">order\_post</a></a>
        </span>
