...
<span class="method apipage">
            ...
            <code class="signature apipage">iterator() : [Iterator](http://api.haxe.org/Iterator.html)&lt;[luxe.structural.BST.T](../../../api/luxe/structural/BST/T.html)&gt;</code><br/><span class="small_desc_flat">returns an iterator from a conversion to array of this tree. Usable as `for(item in tree)`
