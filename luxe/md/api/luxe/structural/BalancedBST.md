...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">compare : [luxe.structural.BalancedBST.K](../../../api/luxe/structural/BalancedBST/K.html)&nbsp; -&gt; [luxe.structural.BalancedBST.K](../../../api/luxe/structural/BalancedBST/K.html)&nbsp;-&gt; [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">The current comparison functoin</span><br/><span class="member apipage">
