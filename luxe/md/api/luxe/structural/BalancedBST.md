...
<span class="method apipage">
            ...
            <code class="signature apipage">compare(:[luxe.structural.BalancedBST.K](../../../api/luxe/structural/BalancedBST/K.html)<span></span>, :[luxe.structural.BalancedBST.K](../../../api/luxe/structural/BalancedBST/K.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">The current comparison function</span>
...
<span class="method apipage">
            <a name="depth"><a class="lift" href="#depth">depth</a></a><span class="inline-block static">inline</span><div class="clear"></div>
...
<span class="method apipage">
            <a name="insert"><a class="lift" href="#insert">insert</a></a><span class="inline-block static">inline</span><div class="clear"></div>
...
<span class="method apipage">
            ...
            <code class="signature apipage">iterator() : [luxe.structural.BalancedBSTIterator](../../../api/luxe/structural/BalancedBSTIterator.html)&lt;[luxe.structural.BalancedBST.K](../../../api/luxe/structural/BalancedBST/K.html), [luxe.structural.BalancedBST.T](../../../api/luxe/structural/BalancedBST/T.html)&gt;</code><br/><span class="small_desc_flat">returns an iterator from a conversion to array of this tree. Usable as `for(item in tree)`</span>
...
<span class="method apipage">
            <a name="size"><a class="lift" href="#size">size</a></a><span class="inline-block static">inline</span><div class="clear"></div>
