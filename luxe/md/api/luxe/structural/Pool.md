...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            If the pool max has been reached the pool will wrap around to the oldest item in the pool.</span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(pool\_size:[Int](http://api.haxe.org/Int.html)<span></span>, create\_callback:[Int](http://api.haxe.org/Int.html)&nbsp; -&gt; [Int](http://api.haxe.org/Int.html)&nbsp;-&gt; [luxe.structural.Pool.T](../../../api/luxe/structural/Pool/T.html)<span></span>, \_precache:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Create a new pool with fixed size,
            on_create callback and cache flag.
            By default precache is true.</span>
