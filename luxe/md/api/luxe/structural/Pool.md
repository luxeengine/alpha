...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                ...
                <code class="signature apipage">items : [Array](#)&lt;[luxe.structural.Pool.T](#)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">get() : [luxe.structural.Pool.T](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(pool\_size:[Int](#)<span></span>, create\_callback:[Int](#)&nbsp; -&gt; [Int](#)&nbsp;-&gt; [luxe.structural.Pool.T](#)<span></span>, \_precache:[Bool](#)<span>=true</span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
