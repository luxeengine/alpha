...
<span class="method apipage">
            ...
            <code class="signature apipage">new(pool\_size:[Int](http://api.haxe.org/Int.html)<span></span>, create\_callback:[Int](http://api.haxe.org/Int.html)&nbsp; -&gt; [Int](http://api.haxe.org/Int.html)&nbsp;-&gt; [luxe.structural.Pool.T](../../../api/luxe/structural/Pool/T.html)<span></span>, \_precache:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Create a new pool with fixed size, on_create callback and cache flag. By default precache sis true.</span>
