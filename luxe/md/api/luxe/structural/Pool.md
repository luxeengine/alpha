...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The available items in the pool.</span><br/><span class="member apipage">
                <a name="size_limit"><a class="lift" href="#size_limit">size\_limit</a></a><div class="clear"></div>
                <code class="signature apipage">size\_limit : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">The fixed size limit, or 0 if no size limit is observed</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="create_func"><a class="lift" href="#create_func">create\_func</a></a><div class="clear"></div>
            <code class="signature apipage">create\_func() : [luxe.structural.Pool.T](../../../api/luxe/structural/Pool/T.html)</code><br/><span class="small_desc_flat">The create callback called if there are no items left in the pool</span>


</span>
<span class="method apipage">
            <a name="get"><a class="lift" href="#get">get</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">get() : [luxe.structural.Pool.T](../../../api/luxe/structural/Pool/T.html)</code><br/><span class="small_desc_flat">Get the next available item from the pool.
            If there are no available items the function returns null.</span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(initial\_size:[Int](http://api.haxe.org/Int.html)<span></span>, fixed\_size\_limit:[Int](http://api.haxe.org/Int.html)<span></span>, create\_callback:[Dynamic](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Create a new pool with an initial cache size, 
            an optional fixed size limit, 
            and create callbacks</span>


</span>
<span class="method apipage">
            <a name="put"><a class="lift" href="#put">put</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">put(item:[luxe.structural.Pool.T](../../../api/luxe/structural/Pool/T.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Return an item to the pool. 
            Take note: This function doesn't care 
            if the item was not in the pool originally,
            and will assert if size_limit is set and would exceed this.</span>
