...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">key : [luxe.structural.BSTNode.K](../../../api/luxe/structural/BSTNode/K.html)</code><br/></span>
            <span class="small_desc_flat">The key used to compare this node</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">left : [luxe.structural.BSTNode](../../../api/luxe/structural/BSTNode.html)&lt;[luxe.structural.BSTNode.K](../../../api/luxe/structural/BSTNode/K.html), [luxe.structural.BSTNode.T](../../../api/luxe/structural/BSTNode/T.html)&gt;</code><br/></span>
            ...
            <span class="small_desc_flat">The node count of this node, including itself</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">right : [luxe.structural.BSTNode](../../../api/luxe/structural/BSTNode.html)&lt;[luxe.structural.BSTNode.K](../../../api/luxe/structural/BSTNode/K.html), [luxe.structural.BSTNode.T](../../../api/luxe/structural/BSTNode/T.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The node right of this node (bigger than)</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">value : [luxe.structural.BSTNode.T](../../../api/luxe/structural/BSTNode/T.html)</code><br/></span>
            <span class="small_desc_flat">The value this node holds</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_key:[luxe.structural.BSTNode.K](../../../api/luxe/structural/BSTNode/K.html)<span></span>, \_value:[luxe.structural.BSTNode.T](../../../api/luxe/structural/BSTNode/T.html)<span></span>, \_nodecount:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Create a new node with given key, value, count. Use `insert` on the tree instead.</span>
