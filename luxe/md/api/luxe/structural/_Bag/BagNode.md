...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">next : [luxe.structural._Bag.BagNode](../../../../api/luxe/structural/_Bag/BagNode.html)&lt;[luxe.structural._Bag.BagNode.T](../../../../api/luxe/structural/_Bag/BagNode/T.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The next node in the linked list</span><br/><span class="member apipage">
                <a name="value"><a class="lift" href="#value">value</a></a><div class="clear"></div>
                <code class="signature apipage">value : [luxe.structural._Bag.BagNode.T](../../../../api/luxe/structural/_Bag/BagNode/T.html)</code><br/></span>
            <span class="small_desc_flat">the node value</span><br/>
