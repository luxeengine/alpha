...
<h1>BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry</h1>
<small>`luxe.structural.BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The key used to compare this node</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">left : [luxe.structural.BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry](../../../api/luxe/structural/BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry.html)</code><br/></span>
            ...
            <span class="small_desc_flat">The node count of this node, including itself</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">right : [luxe.structural.BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry](../../../api/luxe/structural/BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry.html)</code><br/></span>
            <span class="small_desc_flat">The node right of this node (bigger than)</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">value : [phoenix.geometry.Geometry](../../../api/phoenix/geometry/Geometry.html)</code><br/></span>
            <span class="small_desc_flat">The value this node holds</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_key:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>, \_value:[phoenix.geometry.Geometry](../../../api/phoenix/geometry/Geometry.html)<span></span>, \_node\_count:[Int](http://api.haxe.org/Int.html)<span></span>, \_color:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Create a new node with given key, value, count and color. Use `insert` on the tree instead.</span>
