...
<span class="method apipage">
            ...
            <code class="signature apipage">new(omap:[luxe.structural.OrderedMap](../../../api/luxe/structural/OrderedMap.html)&lt;[luxe.structural.OrderedMapIterator.K](../../../api/luxe/structural/OrderedMapIterator/K.html), [luxe.structural.OrderedMapIterator.V](../../../api/luxe/structural/OrderedMapIterator/V.html)&gt;<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="next"><a class="lift" href="#next">next</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">next() : [luxe.structural.OrderedMapIterator.V](../../../api/luxe/structural/OrderedMapIterator/V.html)</code><br/><span class="small_desc_flat"></span>
