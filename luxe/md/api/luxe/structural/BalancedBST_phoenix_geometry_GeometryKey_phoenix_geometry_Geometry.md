...
<h1>BalancedBST_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry</h1>
<small>`luxe.structural.BalancedBST_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">root : [luxe.structural.BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry](../../../api/luxe/structural/BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry.html)</code><br/></span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">ceil(\_key:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>) : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)&gt;</code><br/><span class="small_desc_flat">tree ceiling http://en.wikipedia.org/wiki/Floor_and_ceiling_functions</span>


</span>
<span class="method apipage">
            <a name="compare"><a class="lift" href="#compare">compare</a></a><div class="clear"></div>
            <code class="signature apipage">compare(:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>, :[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">The current comparison functoin</span>


</span>
<span class="method apipage">
            <a name="contains"><a class="lift" href="#contains">contains</a></a><div class="clear"></div>
            <code class="signature apipage">contains(\_key:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">Returns true if the tree contains the key for this node</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">find(\_key:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>) : [phoenix.geometry.Geometry](../../../api/phoenix/geometry/Geometry.html)</code><br/><span class="small_desc_flat">Returns a node by key, if found. null otherwise</span>


</span>
<span class="method apipage">
            <a name="floor"><a class="lift" href="#floor">floor</a></a><div class="clear"></div>
            <code class="signature apipage">floor(\_key:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>) : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)&gt;</code><br/><span class="small_desc_flat">tree floor http://en.wikipedia.org/wiki/Floor_and_ceiling_functions</span>


</span>
<span class="method apipage">
            <a name="insert"><a class="lift" href="#insert">insert</a></a><div class="clear"></div>
            <code class="signature apipage">insert(\_key:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>, \_value:[phoenix.geometry.Geometry](../../../api/phoenix/geometry/Geometry.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Insert a node into the tree</span>


</span>
<span class="method apipage">
            <a name="iterator"><a class="lift" href="#iterator">iterator</a></a><div class="clear"></div>
            <code class="signature apipage">iterator() : [Iterator](#)&lt;[phoenix.geometry.Geometry](../../../api/phoenix/geometry/Geometry.html)&gt;</code><br/><span class="small_desc_flat">returns an iterator from a conversion to array of this tree. Usable as `for(item in tree)`   
...
<span class="method apipage">
            ...
            <code class="signature apipage">keys() : [Array](http://api.haxe.org/Array.html)&lt;[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)&gt;</code><br/><span class="small_desc_flat">Return an array of the keys in this tree</span>


</span>
<span class="method apipage">
            <a name="largest"><a class="lift" href="#largest">largest</a></a><div class="clear"></div>
            <code class="signature apipage">largest() : [phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)</code><br/><span class="small_desc_flat">return the largest node (key) in the tree (most right)</span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(compare\_function:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)&nbsp; -&gt; [phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)&nbsp;-&gt; [Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Create a new balanced BST with the given comparison function</span>


</span>
<span class="method apipage">
            <a name="rank"><a class="lift" href="#rank">rank</a></a><div class="clear"></div>
            <code class="signature apipage">rank(\_key:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">Return the number of nodes to the left of this node, by key.   
...
<span class="method apipage">
            ...
            <code class="signature apipage">remove(\_key:[phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">remove a node by key. return false if the operation fails (i.e the node is not stored in this tree)</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">select(\_rank:[Int](http://api.haxe.org/Int.html)<span></span>) : [phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)</code><br/><span class="small_desc_flat">Find a key by rank in the tree, i.e given a number of nodes, the key at this point.   
            http://en.wikipedia.org/wiki/Order_statistic_tree</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">smallest() : [phoenix.geometry.GeometryKey](../../../api/phoenix/geometry/GeometryKey.html)</code><br/><span class="small_desc_flat">return the smallest node (key) in the tree (most left)</span>


</span>
<span class="method apipage">
            <a name="toArray"><a class="lift" href="#toArray">toArray</a></a><div class="clear"></div>
            <code class="signature apipage">toArray() : [Array](http://api.haxe.org/Array.html)&lt;[phoenix.geometry.Geometry](../../../api/phoenix/geometry/Geometry.html)&gt;</code><br/><span class="small_desc_flat">return an array of the values in this tree</span>


</span>
<span class="method apipage">
            <a name="traverse_node"><a class="lift" href="#traverse_node">traverse\_node</a></a><div class="clear"></div>
            <code class="signature apipage">traverse\_node(\_node:[luxe.structural.BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry](../../../api/luxe/structural/BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry.html)<span></span>, \_method:[luxe.structural.BalancedBSTTraverseMethod](../../../api/luxe/structural/BalancedBSTTraverseMethod.html)<span></span>, \_on\_traverse:[luxe.structural.BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry](../../../api/luxe/structural/BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Traverse a node with the given method, and call the given function for each node traversed</span>
