...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The length of this stack. If 0, the stack is empty</span><br/><span class="member apipage">
                <a name="root"><a class="lift" href="#root">root</a></a><div class="clear"></div>
                <code class="signature apipage">root : [luxe.structural._Bag.BagNode](../../../api/luxe/structural/_Bag/BagNode.html)&lt;[luxe.structural.Bag.T](../../../api/luxe/structural/Bag/T.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The first node in the bag, or null if empty</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="add"><a class="lift" href="#add">add</a></a><div class="clear"></div>
            <code class="signature apipage">add(item:[luxe.structural.Bag.T](../../../api/luxe/structural/Bag/T.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Add an item to this bag</span>


</span>
<span class="method apipage">
            <a name="iterator"><a class="lift" href="#iterator">iterator</a></a><div class="clear"></div>
            <code class="signature apipage">iterator() : [Iterator](http://api.haxe.org/Iterator.html)&lt;[luxe.structural.Bag.T](../../../api/luxe/structural/Bag/T.html)&gt;</code><br/><span class="small_desc_flat">create an iterator for the bag. Usable as `for(item in bag)`</span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">construct a new bag</span>


</span>
<span class="method apipage">
            <a name="toArray"><a class="lift" href="#toArray">toArray</a></a><div class="clear"></div>
            <code class="signature apipage">toArray() : [Array](http://api.haxe.org/Array.html)&lt;[luxe.structural.Bag.T](../../../api/luxe/structural/Bag/T.html)&gt;</code><br/><span class="small_desc_flat">Convert the items in the bag to an array</span>
