...
<span class="method apipage">
            ...
            <code class="signature apipage">iterator() : [Iterator](#)&lt;[luxe.structural.Bag.T](../../../api/luxe/structural/Bag/T.html)&gt;</code><br/><span class="small_desc_flat">create an iterator for the bag. Usable as `for(item in bag)`</span>
