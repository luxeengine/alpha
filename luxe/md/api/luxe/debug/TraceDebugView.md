...
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/debug/TraceDebugView.hx">luxe.debug.TraceDebugView</a></code>
</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">lines : [luxe.Text](../../../api/luxe/Text.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="logged"><a class="lift" href="#logged">logged</a></a><div class="clear"></div>
                <code class="signature apipage">logged : [Array](http://api.haxe.org/Array.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="max_lines"><a class="lift" href="#max_lines">max\_lines</a></a><div class="clear"></div>
                <code class="signature apipage">max\_lines : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="add_line"><a class="lift" href="#add_line">add\_line</a></a><div class="clear"></div>
            <code class="signature apipage">add\_line(\_t:[String](http://api.haxe.org/String.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            <a name="on_trace"><a class="lift" href="#on_trace">on\_trace</a></a><div class="clear"></div>
            <code class="signature apipage">on\_trace(v:[Dynamic](#)<span></span>, inf:[haxe.PosInfos](http://api.haxe.org/haxe/PosInfos.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
