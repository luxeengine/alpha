...
<span class="method apipage">
            ...
            <code class="signature apipage">on\_trace(v:[Dynamic](#)<span></span>, inf:[haxe.PosInfos](http://api.haxe.org/haxe/PosInfos.html)<span>=null</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
