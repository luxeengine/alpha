...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                ...
                <code class="signature apipage">resource\_list\_text : [luxe.Text](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="resource_stats_text"><a class="lift" href="#resource_stats_text">resource\_stats\_text</a></a><div class="clear"></div>
                <code class="signature apipage">resource\_stats\_text : [luxe.Text](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
    ...
    <span class="method apipage">
            ...
            <code class="signature apipage">get\_render\_stats\_string() : [String](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            ...
            <code class="signature apipage">get\_resource\_stats\_string() : [String](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
    ...
    <span class="method apipage">
            ...
            <code class="signature apipage">refresh\_render\_stats() : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
    ...
    <span class="method apipage">
            ...
            <code class="signature apipage">toggle\_debug\_stats() : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="update_render_stats"><a class="lift" href="#update_render_stats">update\_render\_stats</a></a><div class="clear"></div>
            <code class="signature apipage">update\_render\_stats() : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
