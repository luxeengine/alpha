...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_name:[String](http://api.haxe.org/String.html)<span></span>, \_max:[Float](http://api.haxe.org/Float.html)<span></span>, \_color:[luxe.Color](../../../../api/luxe/Color.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
