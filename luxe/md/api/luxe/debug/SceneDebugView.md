...
<h1>SceneDebugView</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/debug/SceneDebugView.hx">luxe.debug.SceneDebugView</a></code>
</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="add_scene"><a class="lift" href="#add_scene">add\_scene</a></a><div class="clear"></div>
            <code class="signature apipage">add\_scene(\_scene:[luxe.Scene](../../../api/luxe/Scene.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            <a name="remove_scene"><a class="lift" href="#remove_scene">remove\_scene</a></a><div class="clear"></div>
            <code class="signature apipage">remove\_scene(\_scene:[luxe.Scene](../../../api/luxe/Scene.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat"></span>
