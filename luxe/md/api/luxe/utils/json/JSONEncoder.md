...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="_trace"><a class="lift" href="#_trace">\_trace</a></a><div class="clear"></div>
            <code class="signature apipage">\_trace(e:[String](http://api.haxe.org/String.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="getString"><a class="lift" href="#getString">getString</a></a><div class="clear"></div>
            <code class="signature apipage">getString() : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat">Gets the JSON string from the encoder.   
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(value:[Dynamic](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Creates a new JSONEncoder.   
