...
<span class="method apipage">
            ...
            <code class="signature apipage">fromCodePoints(codePoints:[Iterable](http://api.haxe.org/Iterable.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;<span></span>) : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat">Converts `codePoints` to a String.</span>
