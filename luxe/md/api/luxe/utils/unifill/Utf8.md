...
<span class="method apipage">
            ...
            <code class="signature apipage">substr(index:[Int](http://api.haxe.org/Int.html)<span></span>, len:[Int](http://api.haxe.org/Int.html)<span></span>) : [luxe.utils.unifill.Utf8](../../../../api/luxe/utils/unifill/Utf8.html)</code><br/><span class="small_desc_flat">Returns `len` code units of `this`, starting at position pos.</span>
