...
<span class="method apipage">
            ...
            <code class="signature apipage">uIterator(s:[String](http://api.haxe.org/String.html)<span></span>) : [luxe.utils.unifill.CodePointIter](../../../../api/luxe/utils/unifill/CodePointIter.html)</code><br/><span class="small_desc_flat">Returns an iterator of the code points of String `s`.</span>
...
<span class="method apipage">
            <a name="uSplit"><a class="lift" href="#uSplit">uSplit</a></a><span class="inline-block static">static</span><div class="clear"></div>
...
<span class="method apipage">
            ...
            <code class="signature apipage">uToString(codePoints:[Iterable](http://api.haxe.org/Iterable.html)&lt;[luxe.utils.unifill.CodePoint](../../../../api/luxe/utils/unifill/CodePoint.html)&gt;<span></span>) : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat">Converts `codePoints` to string.</span>
