...
<span class="method apipage">
            ...
            <code class="signature apipage">segments\_for\_smooth\_circle(\_radius:[Float](http://api.haxe.org/Float.html)<span></span>, \_smooth:[Float](http://api.haxe.org/Float.html)<span>=6</span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>
