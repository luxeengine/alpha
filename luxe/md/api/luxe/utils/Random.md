...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">seed : [Float](http://api.haxe.org/Float.html)</code><br/></span>
...
<h3>Properties</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">initial : [Float](http://api.haxe.org/Float.html)</code><br/></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_initial\_seed:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
