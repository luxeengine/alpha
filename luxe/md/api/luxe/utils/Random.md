...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">bit(chance:[Float](http://api.haxe.org/Float.html)<span>=0.5f</span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">Returns 1 or 0 based on a chance of [0..1] percent.
...
<span class="method apipage">
            ...
            <code class="signature apipage">bool(chance:[Float](http://api.haxe.org/Float.html)<span>=0.5f</span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">Returns true or false based on a chance of [0..1] percent.
...
<span class="method apipage">
            ...
            <code class="signature apipage">float(min:[Float](http://api.haxe.org/Float.html)<span></span>, max:[Float](http://api.haxe.org/Float.html)<span>=null</span>) : [Float](http://api.haxe.org/Float.html)</code><br/><span class="small_desc_flat">Returns a number between [min,max).
...
<span class="method apipage">
            ...
            <code class="signature apipage">int(min:[Float](http://api.haxe.org/Float.html)<span></span>, max:[Float](http://api.haxe.org/Float.html)<span>=null</span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">Return a number between [min, max).
            max is optional, returning a number between [0,min)</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">sign(chance:[Float](http://api.haxe.org/Float.html)<span>=0.5f</span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">Returns 1 or -1 based on a chance of [0..1] percent.
            Given 0.5, 50% chance of 1, with 0.9, 90% chance of 1 and so on.</span>
