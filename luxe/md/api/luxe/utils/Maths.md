...
<span class="method apipage">
            <a name="vec_dot"><a class="lift" href="#vec_dot">vec\_dot</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">vec\_dot(x:[Float](http://api.haxe.org/Float.html)<span></span>, y:[Float](http://api.haxe.org/Float.html)<span></span>, otherx:[Float](http://api.haxe.org/Float.html)<span></span>, othery:[Float](http://api.haxe.org/Float.html)<span></span>) : [Float](http://api.haxe.org/Float.html)</code><br/><span class="small_desc_flat">Returns the dot product between two vectors by components</span>


</span>
<span class="method apipage">
            <a name="vec_length"><a class="lift" href="#vec_length">vec\_length</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">vec\_length(x:[Float](http://api.haxe.org/Float.html)<span></span>, y:[Float](http://api.haxe.org/Float.html)<span></span>) : [Float](http://api.haxe.org/Float.html)</code><br/><span class="small_desc_flat">Get the length of a vector by components</span>


</span>
<span class="method apipage">
            <a name="vec_lengthsq"><a class="lift" href="#vec_lengthsq">vec\_lengthsq</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">vec\_lengthsq(x:[Float](http://api.haxe.org/Float.html)<span></span>, y:[Float](http://api.haxe.org/Float.html)<span></span>) : [Float](http://api.haxe.org/Float.html)</code><br/><span class="small_desc_flat">Get the length squared of a vector by components</span>


</span>
<span class="method apipage">
            <a name="vec_normalize"><a class="lift" href="#vec_normalize">vec\_normalize</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">vec\_normalize(length:[Float](http://api.haxe.org/Float.html)<span></span>, component:[Float](http://api.haxe.org/Float.html)<span></span>) : [Float](http://api.haxe.org/Float.html)</code><br/><span class="small_desc_flat">Normalize the component of a vector based on it's length</span>
