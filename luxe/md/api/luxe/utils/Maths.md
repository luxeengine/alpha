...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="DEG2RAD"><a class="lift" href="#DEG2RAD">DEG2RAD</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">DEG2RAD : [Float](http://api.haxe.org/Float.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="RAD2DEG"><a class="lift" href="#RAD2DEG">RAD2DEG</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">RAD2DEG : [Float](http://api.haxe.org/Float.html)</code><br/></span>
