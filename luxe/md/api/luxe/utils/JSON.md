...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="decode"><a class="lift" href="#decode">decode</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">decode(s:[String](http://api.haxe.org/String.html)<span></span>, strict:[Bool](http://api.haxe.org/Bool.html)<span>=true</span>) : [Dynamic](#)</code><br/><span class="small_desc_flat">Decodes a JSON string into a native object.   
...
<span class="method apipage">
            <a name="encode"><a class="lift" href="#encode">encode</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">encode(o:[Dynamic](#)<span></span>) : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat">Encodes a object into a JSON string.   
...
<span class="method apipage">
            <a name="parse"><a class="lift" href="#parse">parse</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">parse(s:[String](http://api.haxe.org/String.html)<span></span>, strict:[Bool](http://api.haxe.org/Bool.html)<span>=false</span>) : [Dynamic](#)</code><br/><span class="small_desc_flat">Decodes a JSON string into a native object.   
...
<span class="method apipage">
            <a name="stringify"><a class="lift" href="#stringify">stringify</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">stringify(o:[Dynamic](#)<span></span>) : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat">Encodes a object into a JSON string.   
