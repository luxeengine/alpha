...
<h1>Murmur3</h1>
<small>`luxe.utils.Murmur3`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">hash(bytes:[haxe.io.Bytes](http://api.haxe.org/haxe/io/Bytes.html)<span></span>, seed:[UInt](#)<span>=0</span>) : [UInt](#)</code><br/><span class="small_desc_flat">* Returns the hash value of the input bytes.
     *
     * @param haxe.io.Bytes bytes the bytes to get the hash for
     * @param UInt          seed  an optional seed value
     *
     * @return UInt the hash value</span>
