...
<span class="method apipage">
            ...
            <code class="signature apipage">hash(string:[String](http://api.haxe.org/String.html)<span></span>) : [UInt](http://api.haxe.org/UInt.html)</code><br/><span class="small_desc_flat">Generates a integer hash from a string using the default algorithm (murmur3)</span>


</span>
<span class="method apipage">
            <a name="hashdjb2"><a class="lift" href="#hashdjb2">hashdjb2</a></a><div class="clear"></div>
            <code class="signature apipage">hashdjb2(string:[String](http://api.haxe.org/String.html)<span></span>) : [UInt](http://api.haxe.org/UInt.html)</code><br/><span class="small_desc_flat">Generates an integer hash of a string using the djb2 algorithm</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">premultiply\_alpha(\_pixels:[snow.api.buffers.Uint8Array](https://snowkit.github.io/snow/api/snow/api/buffers/Uint8Array.html)<span></span>) : [snow.api.buffers.Uint8Array](https://snowkit.github.io/snow/api/snow/api/buffers/Uint8Array.html)</code><br/><span class="small_desc_flat">Multiply the pixels in the array by their alpha value.
...
<span class="method apipage">
            ...
            <code class="signature apipage">premultiply\_alpha\_normalized(\_pixels:[snow.api.buffers.Uint8Array](https://snowkit.github.io/snow/api/snow/api/buffers/Uint8Array.html)<span></span>) : [snow.api.buffers.Uint8Array](https://snowkit.github.io/snow/api/snow/api/buffers/Uint8Array.html)</code><br/><span class="small_desc_flat">Multiply the pixels in the array by their alpha value.
...
<span class="method apipage">
            ...
            <code class="signature apipage">uniquehash() : [UInt](http://api.haxe.org/UInt.html)</code><br/><span class="small_desc_flat">Generates and returns a uniqueid converted to a hashed integer for convenience.
