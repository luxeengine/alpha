...
<h1>TiledImageLayer</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/importers/tiled/TiledImageLayer.hx">luxe.importers.tiled.TiledImageLayer</a></code>
</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">image : [luxe.importers.tiled.TiledImage](../../../../api/luxe/importers/tiled/TiledImage.html)</code><br/></span>
            <span class="small_desc_flat">The image information for this image layer</span><br/><span class="member apipage">
                <a name="map"><a class="lift" href="#map">map</a></a><div class="clear"></div>
                <code class="signature apipage">map : [luxe.importers.tiled.TiledMapData](../../../../api/luxe/importers/tiled/TiledMapData.html)</code><br/></span>
            <span class="small_desc_flat">The tiledmap this belongs to</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The name of the image layer</span><br/><span class="member apipage">
                <a name="opacity"><a class="lift" href="#opacity">opacity</a></a><div class="clear"></div>
                <code class="signature apipage">opacity : [Float](http://api.haxe.org/Float.html)</code><br/></span>
            <span class="small_desc_flat">opacity: The opacity of the layer as a value from 0 to 1.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Contains all properties from this image layer</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The x position of the image layer in pixels</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The y position of the image layer in pixels</span><br/>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_map:[luxe.importers.tiled.TiledMapData](../../../../api/luxe/importers/tiled/TiledMapData.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
