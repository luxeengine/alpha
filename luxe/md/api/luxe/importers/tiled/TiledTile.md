...
<h1>TiledTile</h1>
<small>`luxe.importers.tiled.TiledTile`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">layer : [luxe.importers.tiled.TiledLayer](../../../../api/luxe/importers/tiled/TiledLayer.html)</code><br/></span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">get\_height() : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="get_width"><a class="lift" href="#get_width">get\_width</a></a><div class="clear"></div>
            <code class="signature apipage">get\_width() : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_layer:[luxe.importers.tiled.TiledLayer](../../../../api/luxe/importers/tiled/TiledLayer.html)<span></span>, \_id:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
