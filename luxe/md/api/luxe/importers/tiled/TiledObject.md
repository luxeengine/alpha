...
<span class="method apipage">
            ...
            <code class="signature apipage">from\_xml(xml:[Xml](http://api.haxe.org/Xml.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
