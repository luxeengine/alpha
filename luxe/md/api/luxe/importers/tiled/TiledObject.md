...
<h1>TiledObject</h1>
<small>`luxe.importers.tiled.TiledObject` defined in `luxe.importers.tiled.TiledObjectGroup`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">gid : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">A reference to a tile (optional).</span><br/><span class="member apipage">
                <a name="group"><a class="lift" href="#group">group</a></a><div class="clear"></div>
                <code class="signature apipage">group : [luxe.importers.tiled.TiledObjectGroup](../../../../api/luxe/importers/tiled/TiledObjectGroup.html)</code><br/></span>
            <span class="small_desc_flat">The group that this TiledObject is from</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The width of this object in pixels</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Unique ID of the object. Each object that is placed on a map gets a unique id.
            Even if an object was deleted, no object gets the same ID.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The name of this object</span><br/><span class="member apipage">
                <a name="object_type"><a class="lift" href="#object_type">object\_type</a></a><div class="clear"></div>
                <code class="signature apipage">object\_type : [luxe.importers.tiled.TiledObjectType](../../../../api/luxe/importers/tiled/TiledObjectType.html)</code><br/></span>
            <span class="small_desc_flat">The type of object this object represents</span><br/><span class="member apipage">
                <a name="polyobject"><a class="lift" href="#polyobject">polyobject</a></a><div class="clear"></div>
                <code class="signature apipage">polyobject : [luxe.importers.tiled.TiledPolyObject](../../../../api/luxe/importers/tiled/TiledPolyObject.html)</code><br/></span>
            <span class="small_desc_flat">The object that represents a poly-like object (line/polygon)</span><br/><span class="member apipage">
                <a name="pos"><a class="lift" href="#pos">pos</a></a><div class="clear"></div>
                <code class="signature apipage">pos : [luxe.Vector](../../../../api/luxe/Vector.html)</code><br/></span>
            <span class="small_desc_flat">The x coordinate of this object (in pixels!)</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Contains all properties from this object</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The rotation of the object in degrees clockwise</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The type of this object</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">if it's visible</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The width of this object in pixels</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="from_json"><a class="lift" href="#from_json">from\_json</a></a><div class="clear"></div>
            <code class="signature apipage">from\_json(json:[Dynamic](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="from_xml"><a class="lift" href="#from_xml">from\_xml</a></a><div class="clear"></div>
            <code class="signature apipage">from\_xml(xml:[Xml](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_group:[luxe.importers.tiled.TiledObjectGroup](../../../../api/luxe/importers/tiled/TiledObjectGroup.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
