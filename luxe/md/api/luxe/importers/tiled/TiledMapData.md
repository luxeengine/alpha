...
<h1>TiledMapData</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/importers/tiled/TiledMapData.hx">luxe.importers.tiled.TiledMapData</a></code>
</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="background_color"><a class="lift" href="#background_color">background\_color</a></a><div class="clear"></div>
                <code class="signature apipage">background\_color : [String](http://api.haxe.org/String.html)</code><br/></span>
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="image_layers"><a class="lift" href="#image_layers">image\_layers</a></a><div class="clear"></div>
                <code class="signature apipage">image\_layers : [Array](http://api.haxe.org/Array.html)&lt;[luxe.importers.tiled.TiledImageLayer](../../../../api/luxe/importers/tiled/TiledImageLayer.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="layers"><a class="lift" href="#layers">layers</a></a><div class="clear"></div>
                <code class="signature apipage">layers : [Array](http://api.haxe.org/Array.html)&lt;[luxe.importers.tiled.TiledLayer](../../../../api/luxe/importers/tiled/TiledLayer.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="object_groups"><a class="lift" href="#object_groups">object\_groups</a></a><div class="clear"></div>
                <code class="signature apipage">object\_groups : [Array](http://api.haxe.org/Array.html)&lt;[luxe.importers.tiled.TiledObjectGroup](../../../../api/luxe/importers/tiled/TiledObjectGroup.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">tilesets : [Array](http://api.haxe.org/Array.html)&lt;[luxe.importers.tiled.TiledTileset](../../../../api/luxe/importers/tiled/TiledTileset.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<span class="method apipage">
            <a name="parseFromJSON"><a class="lift" href="#parseFromJSON">parseFromJSON</a></a><div class="clear"></div>
            <code class="signature apipage">parseFromJSON(json:[Dynamic](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="parseFromXML"><a class="lift" href="#parseFromXML">parseFromXML</a></a><div class="clear"></div>
            <code class="signature apipage">parseFromXML(xml:[Xml](http://api.haxe.org/Xml.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
