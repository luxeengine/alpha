...
<h1>TiledMapData</h1>
<small>`luxe.importers.tiled.TiledMapData` defined in ``</small>
...
<span class="method apipage">
            ...
            <code class="signature apipage">parseFromXML(xml:[Xml](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
