...
<h1>TiledTileset</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/importers/tiled/TiledTileset.hx">luxe.importers.tiled.TiledTileset</a></code>
</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="property_tiles"><a class="lift" href="#property_tiles">property\_tiles</a></a><div class="clear"></div>
                <code class="signature apipage">property\_tiles : [Map](http://api.haxe.org/Map.html)&lt;[Int](http://api.haxe.org/Int.html), [luxe.importers.tiled.TiledPropertyTile](../../../../api/luxe/importers/tiled/TiledPropertyTile.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="texture_name"><a class="lift" href="#texture_name">texture\_name</a></a><div class="clear"></div>
                <code class="signature apipage">texture\_name : [String](http://api.haxe.org/String.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
