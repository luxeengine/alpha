...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(input:[haxe.io.Input](http://api.haxe.org/haxe/io/Input.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="read"><a class="lift" href="#read">read</a></a><div class="clear"></div>
            <code class="signature apipage">read() : [luxe.importers.obj.Data](../../../../api/luxe/importers/obj/Data.html)</code><br/><span class="small_desc_flat"></span>
