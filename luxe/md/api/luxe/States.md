...
<span class="method apipage">
            ...
            <code class="signature apipage">set&lt;T1&gt;, T2&gt;(name:[String](http://api.haxe.org/String.html)<span></span>, \_enter\_with:[set.T1](#)<span></span>, \_leave\_with:[set.T2](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
