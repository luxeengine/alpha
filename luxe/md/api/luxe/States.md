...
<h1>States</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/States.hx">luxe.States</a></code>
</small>
...
<span class="method apipage">
            ...
            <code class="signature apipage">set&lt;T1&gt;, T2&gt;(name:[String](http://api.haxe.org/String.html)<span></span>, \_enter\_with:[set.T1](#)<span></span>, \_leave\_with:[set.T2](#)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">Change the actively set state.</span>


</span>
<span class="method apipage">
            <a name="unset"><a class="lift" href="#unset">unset</a></a><div class="clear"></div>
            <code class="signature apipage">unset&lt;T&gt;(\_leave\_with:[unset.T](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Exit the actively set state.</span>
