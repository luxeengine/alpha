...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The window id this event originated from</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">type : [luxe.TextEventType](../../api/luxe/TextEventType.html)</code><br/></span>
            ...
            <span class="small_desc_flat">The length position, if the `type` is `edit`</span><br/>
