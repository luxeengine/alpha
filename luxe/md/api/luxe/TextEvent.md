...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The window id this event originated from</span><span class="member apipage">
                <a name="type"><a class="lift" href="#type">type</a></a><div class="clear"></div><code class="signature apipage">type : [luxe.TextEventType](#)</code><br/></span>
            <span class="small_desc_flat">The type of text event</span><span class="member apipage">
            ...
            <span class="small_desc_flat">The text that this event has generated</span><span class="member apipage">
                <a name="start"><a class="lift" href="#start">start</a></a><div class="clear"></div><code class="signature apipage">start : [Int](#)</code><br/></span>
            <span class="small_desc_flat">The start position, if the `type` is `edit`</span><span class="member apipage">
            ...
            <span class="small_desc_flat">The length position, if the `type` is `edit`</span>
