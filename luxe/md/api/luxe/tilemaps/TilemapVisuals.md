...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">geometry : [Map](http://api.haxe.org/Map.html)&lt;[String](http://api.haxe.org/String.html), [luxe.tilemaps.TilemapVisualsLayerGeometry](../../../api/luxe/tilemaps/TilemapVisualsLayerGeometry.html)&gt;</code><br/></span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">create(options:[Dynamic](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_map:[luxe.tilemaps.Tilemap](../../../api/luxe/tilemaps/Tilemap.html)<span></span>, options:[Dynamic](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="refresh_tile_id"><a class="lift" href="#refresh_tile_id">refresh\_tile\_id</a></a><div class="clear"></div>
            <code class="signature apipage">refresh\_tile\_id(\_layer\_name:[String](http://api.haxe.org/String.html)<span></span>, \_x:[Int](http://api.haxe.org/Int.html)<span></span>, \_y:[Int](http://api.haxe.org/Int.html)<span></span>, \_id:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
