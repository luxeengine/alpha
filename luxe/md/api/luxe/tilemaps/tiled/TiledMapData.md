...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">background\_color : [String](#)</code><br/></span>
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                ...
                <code class="signature apipage">layers : [Array](#)&lt;[luxe.tilemaps.tiled.TiledLayer](#)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="object_groups"><a class="lift" href="#object_groups">object\_groups</a></a><div class="clear"></div>
                <code class="signature apipage">object\_groups : [Array](#)&lt;[luxe.tilemaps.tiled.TiledObjectGroup](#)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                ...
                <code class="signature apipage">tilesets : [Array](#)&lt;[luxe.tilemaps.tiled.TiledTileset](#)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
    ...
    <span class="method apipage">
            ...
            <code class="signature apipage">parseFromJSON(json:[Dynamic](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
