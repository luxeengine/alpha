...
<h1>TileLayer</h1>
<small>`luxe.tilemaps.TileLayer` defined in `luxe.tilemaps.Tilemap`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="fixed"><a class="lift" href="#fixed">fixed</a></a><div class="clear"></div>
                <code class="signature apipage">fixed : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat">The layer static state.
            When fixed, visuals can optimize the geometry</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the unique id of the layer</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the depth/ordering value</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the map this tilemap belongs to</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the name of the layer</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the layer opacity. default: 1</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">layer properties</span><br/><span class="member apipage">
                <a name="tiles"><a class="lift" href="#tiles">tiles</a></a><div class="clear"></div>
                <code class="signature apipage">tiles : [Array](http://api.haxe.org/Array.html)&lt;[luxe.tilemaps.TileArray](../../../api/luxe/tilemaps/TileArray.html)&gt;</code><br/></span>
            <span class="small_desc_flat">array of array of tiles</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the layer visibility. default: true</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="bounds_fitted"><a class="lift" href="#bounds_fitted">bounds\_fitted</a></a><div class="clear"></div>
            <code class="signature apipage">bounds\_fitted() : [Array](http://api.haxe.org/Array.html)&lt;[luxe.Rectangle](../../../api/luxe/Rectangle.html)&gt;</code><br/><span class="small_desc_flat">Returns a list of rectangles in tile space, 
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(options:[luxe.options.TileLayerOptions](../../../api/luxe/options/TileLayerOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
