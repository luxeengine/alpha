...
<span class="method apipage">
            ...
            <code class="signature apipage">refresh\_tile\_id(\_layer\_name:[String](http://api.haxe.org/String.html)<span></span>, \_x:[Int](http://api.haxe.org/Int.html)<span></span>, \_y:[Int](http://api.haxe.org/Int.html)<span></span>, \_id:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Update the visual to match a new tile id at a given coordinate.
            This is called automatically when you set a `Tile` ID in a map, if it has a visual assigned.</span>
