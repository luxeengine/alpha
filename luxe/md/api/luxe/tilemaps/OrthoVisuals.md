...
`class`extends <code><span>luxe.tilemaps.TilemapVisuals</span></code><br/><span class="meta">
meta: @:keep</span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">create(options:[luxe.options.TilemapVisualOptions](../../../api/luxe/options/TilemapVisualOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
