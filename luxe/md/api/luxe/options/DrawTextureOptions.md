...
<small>
<code>luxe.options.DrawTextureOptions</code> defined in <code><a href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/options/DrawOptions.hx" target="_blank">luxe.options.DrawOptions</a></code>
</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">the uv coordinates for the created quad, in texture size (pixels)</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the size to draw the texture at. An alternative to `w`,`h`. If this is specifed, w,h is ignored.</span><br/><span class="member apipage">
