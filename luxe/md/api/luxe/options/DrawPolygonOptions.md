...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not the polygon is solid.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the transform position</span><br/><span class="member apipage">
                <a name="points"><a class="lift" href="#points">points</a></a><div class="clear"></div>
                <code class="signature apipage">points : [Array](http://api.haxe.org/Array.html)&lt;[luxe.Vector](../../../api/luxe/Vector.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The list of points to add to the polyline</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the geometry depth value (see guides)</span><br/><span class="member apipage">
                <a name="colors"><a class="lift" href="#colors">colors</a></a><div class="clear"></div>
                <code class="signature apipage">colors : [Null](http://api.haxe.org/Null.html)&lt;[Array](http://api.haxe.org/Array.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The list of colors, per point. Must match length with the points list</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">A color to share for all points.</span><br/><span class="member apipage">
