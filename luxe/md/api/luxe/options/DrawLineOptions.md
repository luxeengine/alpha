...
<small>`luxe.options.DrawLineOptions` defined in `luxe.options.DrawOptions`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">the transform position</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">p1 : [Null](http://api.haxe.org/Null.html)&lt;[luxe.Vector](../../../api/luxe/Vector.html)&gt;</code><br/></span>
            <span class="small_desc_flat">the end point of the line</span><br/><span class="member apipage">
                <a name="p0"><a class="lift" href="#p0">p0</a></a><div class="clear"></div>
                <code class="signature apipage">p0 : [Null](http://api.haxe.org/Null.html)&lt;[luxe.Vector](../../../api/luxe/Vector.html)&gt;</code><br/></span>
            <span class="small_desc_flat">the start point of the line</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the geometry depth value (see guides)</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">color1 : [Null](http://api.haxe.org/Null.html)&lt;[luxe.Color](../../../api/luxe/Color.html)&gt;</code><br/></span>
            <span class="small_desc_flat">specified only if per vertex color is desired, use .color for both</span><br/><span class="member apipage">
                <a name="color0"><a class="lift" href="#color0">color0</a></a><div class="clear"></div>
                <code class="signature apipage">color0 : [Null](http://api.haxe.org/Null.html)&lt;[luxe.Color](../../../api/luxe/Color.html)&gt;</code><br/></span>
            <span class="small_desc_flat">specified only if per vertex color is desired, use .color for both</span><br/><span class="member apipage">
