...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">textures : [Null](http://api.haxe.org/Null.html)&lt;[Array](http://api.haxe.org/Array.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Adds these texture items to the parcel initially</span><br/><span class="member apipage">
                <a name="texts"><a class="lift" href="#texts">texts</a></a><div class="clear"></div>
                <code class="signature apipage">texts : [Null](http://api.haxe.org/Null.html)&lt;[Array](http://api.haxe.org/Array.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Adds these text items to the parcel initially</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The Resources system that manages this parcel. default: Luxe.resources</span><br/><span class="member apipage">
                <a name="sounds"><a class="lift" href="#sounds">sounds</a></a><div class="clear"></div>
                <code class="signature apipage">sounds : [Null](http://api.haxe.org/Null.html)&lt;[Array](http://api.haxe.org/Array.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Adds these sound items to the parcel initially</span><br/><span class="member apipage">
                <a name="shaders"><a class="lift" href="#shaders">shaders</a></a><div class="clear"></div>
                <code class="signature apipage">shaders : [Null](http://api.haxe.org/Null.html)&lt;[Array](http://api.haxe.org/Array.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Adds these shader items to the parcel initially</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">An optional callback for when an item in the parcel completes loading.</span><br/><span class="member apipage">
                <a name="onfailed"><a class="lift" href="#onfailed">onfailed</a></a><div class="clear"></div>
                <code class="signature apipage">onfailed : [Null](http://api.haxe.org/Null.html)&lt;[](#)&gt;</code><br/></span>
            <span class="small_desc_flat">An optional callback for when an item in the parcel fails to load.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">An optional callback for when all items are loaded in a `load` call.</span><br/><span class="member apipage">
                <a name="load_time_spacing"><a class="lift" href="#load_time_spacing">load\_time\_spacing</a></a><div class="clear"></div>
                <code class="signature apipage">load\_time\_spacing : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat">A short gap before subsequent loads are triggered.
            Having a small window allows the rendering + progress to update, if
            the load calls are synchronous they will prevent
            updates from happening, having the appearance of freezing. default: `1/20`</span><br/><span class="member apipage">
                <a name="load_start_delay"><a class="lift" href="#load_start_delay">load\_start\_delay</a></a><div class="clear"></div>
                <code class="signature apipage">load\_start\_delay : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat">A delay before starting the actually work
            when `load` is called. Having a small window
            allows the rendering + progress to update, if
            the load calls are synchronous they will prevent
            updates from happening, having the appearance of freezing. `default: 0.2`</span><br/><span class="member apipage">
                <a name="jsons"><a class="lift" href="#jsons">jsons</a></a><div class="clear"></div>
                <code class="signature apipage">jsons : [Null](http://api.haxe.org/Null.html)&lt;[Array](http://api.haxe.org/Array.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Adds these json items to the parcel initially</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The id of this parcel.</span><br/><span class="member apipage">
                <a name="fonts"><a class="lift" href="#fonts">fonts</a></a><div class="clear"></div>
                <code class="signature apipage">fonts : [Null](http://api.haxe.org/Null.html)&lt;[Array](http://api.haxe.org/Array.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Adds these font items to the parcel initially</span><br/><span class="member apipage">
                <a name="bytes"><a class="lift" href="#bytes">bytes</a></a><div class="clear"></div>
                <code class="signature apipage">bytes : [Null](http://api.haxe.org/Null.html)&lt;[Array](http://api.haxe.org/Array.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Adds these bytes items to the parcel initially</span><br/>
