...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="texture_path"><a class="lift" href="#texture_path">texture\_path</a></a><div class="clear"></div>
                <code class="signature apipage">texture\_path : [Null](http://api.haxe.org/Null.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">An optional path for the font textures. This is to allow the .fnt file to be separate from the texture files.
            Take note that the font fnt file specifies the pages with a path as well, which would become relative to this given path,
            and if this is not specified the images will be relative to the .fnt file.</span><br/><span class="member apipage">
                <a name="silent"><a class="lift" href="#silent">silent</a></a><div class="clear"></div>
                <code class="signature apipage">silent : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Whether or not this and it's resources load without logging. default: false</span><br/><span class="member apipage">
                <a name="resources"><a class="lift" href="#resources">resources</a></a><div class="clear"></div>
                <code class="signature apipage">resources : [Null](http://api.haxe.org/Null.html)&lt;[luxe.resource.Resources](../../../api/luxe/resource/Resources.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The resource manager to associate this font with. default: `Luxe.resources`</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The callback to call when the font finishes loading</span><br/><span class="member apipage">
                <a name="mipmaps"><a class="lift" href="#mipmaps">mipmaps</a></a><div class="clear"></div>
                <code class="signature apipage">mipmaps : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Whether or not the texture pages generate mipmaps automatically. default: false</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The file asset id of the font data to use/load. Textures inside the fnt file are loaded relative to the fnt file
            location, use `texture_path` to override this. Required if using load.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Loaded/assigned textures will use this filter minification mode. default: linear</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Loaded/assigned textures will use this filter magnification mode. default: linear</span><br/><span class="member apipage">
                <a name="filter"><a class="lift" href="#filter">filter</a></a><div class="clear"></div>
                <code class="signature apipage">filter : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.FilterType](../../../api/phoenix/FilterType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Loaded/assigned textures will use this filter mode. default: linear</span><br/>
