...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">When creating a texture manually, the width this texture should be.</span><br/><span class="member apipage">
                <a name="type"><a class="lift" href="#type">type</a></a><div class="clear"></div>
                <code class="signature apipage">type : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.TextureType](../../../api/phoenix/TextureType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Advanced: Specify the type this texture represents, like Texture 2D, Cube map.</span><br/><span class="member apipage">
                <a name="texture"><a class="lift" href="#texture">texture</a></a><div class="clear"></div>
                <code class="signature apipage">texture : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.TextureID](../../../api/phoenix/TextureID.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Advanced: Specify a pre-created renderer specific TextureID for this Texture.</span><br/><span class="member apipage">
                <a name="system"><a class="lift" href="#system">system</a></a><div class="clear"></div>
                <code class="signature apipage">system : [Null](http://api.haxe.org/Null.html)&lt;[luxe.Resources](../../../api/luxe/Resources.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Internal: The Resources system that contains this resource. Defaults to Luxe.resources,
            and is very rarely required to be specified manually.</span><br/><span class="member apipage">
                <a name="resource_type"><a class="lift" href="#resource_type">resource\_type</a></a><div class="clear"></div>
                <code class="signature apipage">resource\_type : [Null](http://api.haxe.org/Null.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Internal: The Resource type id for this resource. Usually overridden by the Resource types.
            Corresponds with ResourceType, but used as int for user typed resource type ids.</span><br/><span class="member apipage">
                <a name="pixels"><a class="lift" href="#pixels">pixels</a></a><div class="clear"></div>
                <code class="signature apipage">pixels : [Null](http://api.haxe.org/Null.html)&lt;[snow.api.buffers.Uint8Array](#)&gt;</code><br/></span>
            <span class="small_desc_flat">When creating a texture manually, the pixels for this texture.</span><br/><span class="member apipage">
                <a name="load_premultiply_alpha"><a class="lift" href="#load_premultiply_alpha">load\_premultiply\_alpha</a></a><div class="clear"></div>
                <code class="signature apipage">load\_premultiply\_alpha : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Advanced: When reloading from an asset id, the pixels will be
                premultiplied with their alpha value before `submit`.
                Only applies to asset based load calls. Subsequent `submit` calls
                should use Luxe.utils.premultiply_alpha if needed. `default: false`</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The unique resource ID.
            If the resource is loaded from disk, this matches the asset id.
            If not from disk, the id can be anything but must be unique to this resource.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">When creating a texture manually, the height this texture should be.</span><br/><span class="member apipage">
                <a name="format"><a class="lift" href="#format">format</a></a><div class="clear"></div>
                <code class="signature apipage">format : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.TextureFormat](../../../api/phoenix/TextureFormat.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Advanced: Specify the renderer specific format for this texture, i.e `GL.RGBA` or similar.
            Note that this is dependent on the hardware, renderer API level, and more.</span><br/><span class="member apipage">
                <a name="filter_min"><a class="lift" href="#filter_min">filter\_min</a></a><div class="clear"></div>
                <code class="signature apipage">filter\_min : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.FilterType](../../../api/phoenix/FilterType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Specify the minification filter type</span><br/><span class="member apipage">
                <a name="filter_mag"><a class="lift" href="#filter_mag">filter\_mag</a></a><div class="clear"></div>
                <code class="signature apipage">filter\_mag : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.FilterType](../../../api/phoenix/FilterType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Specify the magnification filter type</span><br/><span class="member apipage">
                <a name="data_type"><a class="lift" href="#data_type">data\_type</a></a><div class="clear"></div>
                <code class="signature apipage">data\_type : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.TextureDataType](../../../api/phoenix/TextureDataType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Advanced: Specify the renderer specific data type for this texture, i.e `GL.UNSIGNED_BYTE` or similar.
            Note that this is dependent on the hardware, renderer API level, and more.</span><br/><span class="member apipage">
                <a name="compressed"><a class="lift" href="#compressed">compressed</a></a><div class="clear"></div>
                <code class="signature apipage">compressed : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Advanced: Specify if this is a compressed pixel format</span><br/><span class="member apipage">
                <a name="clamp_t"><a class="lift" href="#clamp_t">clamp\_t</a></a><div class="clear"></div>
                <code class="signature apipage">clamp\_t : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.ClampType](../../../api/phoenix/ClampType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Sets the T (vertical) clamp type</span><br/><span class="member apipage">
                <a name="clamp_s"><a class="lift" href="#clamp_s">clamp\_s</a></a><div class="clear"></div>
                <code class="signature apipage">clamp\_s : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.ClampType](../../../api/phoenix/ClampType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Sets the S (horizontal) clamp type</span><br/>
