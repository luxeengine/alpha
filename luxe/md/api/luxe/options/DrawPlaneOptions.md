...
`typedef`&nbsp;alias of `luxe.options.PlaneGeometryOptions`   
<br/><span class="meta">
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">z : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat">z position</span><br/><span class="member apipage">
