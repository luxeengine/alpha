...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">no\_add : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">set to true, to disable adding to the renderer</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The name of this batcher. highly recommended you set this.</span><br/><span class="member apipage">
                <a name="layer"><a class="lift" href="#layer">layer</a></a><div class="clear"></div>
                <code class="signature apipage">layer : [Null](http://api.haxe.org/Null.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;</code><br/></span>
            <span class="small_desc_flat">the order/layer for this batcher in the renderer.</span><br/><span class="member apipage">
                <a name="camera"><a class="lift" href="#camera">camera</a></a><div class="clear"></div>
                <code class="signature apipage">camera : [Null](http://api.haxe.org/Null.html)&lt;[phoenix.Camera](../../../api/phoenix/Camera.html)&gt;</code><br/></span>
            <span class="small_desc_flat">a phoenix camera view for the batcher. If you have a luxe.Camera, use the .view property from it.</span><br/>
