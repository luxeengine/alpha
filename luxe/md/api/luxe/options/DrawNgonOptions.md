...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">center point y</span><span class="member apipage">
                <a name="x"><a class="lift" href="#x">x</a></a><div class="clear"></div>
                <code class="signature apipage">x : [Null](#)&lt;[Float](#)&gt;</code><br/></span>
            <span class="small_desc_flat">center point x</span><span class="member apipage">
            ...
            <span class="small_desc_flat">the texture for the geometry</span><span class="member apipage">
                ...
                <code class="signature apipage">solid : [Null](#)&lt;[Bool](#)&gt;</code><br/></span>
            <span class="small_desc_flat">whether or not this is an outline or a solid filled ngon</span><span class="member apipage">
                <a name="sides"><a class="lift" href="#sides">sides</a></a><div class="clear"></div>
                <code class="signature apipage">sides : [Null](#)&lt;[Int](#)&gt;</code><br/></span>
            <span class="small_desc_flat">The number of sides. For a triangle, 3. For a square, 4, etc.</span><span class="member apipage">
        ...
        around the center point x,y</span><span class="member apipage">
            ...
            <span class="small_desc_flat">the batcher to add this geometry to (unless no_batcher_add). If not specified, the default batcher is used.</span><span class="member apipage">
                <a name="angle"><a class="lift" href="#angle">angle</a></a><div class="clear"></div>
                <code class="signature apipage">angle : [Null](#)&lt;[Float](#)&gt;</code><br/></span>
            <span class="small_desc_flat">an offset rotation angle in degrees</span>
