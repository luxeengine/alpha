...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">center point y</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">center point x</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the texture for the geometry</span><br/><span class="member apipage">
                <a name="solid"><a class="lift" href="#solid">solid</a></a><div class="clear"></div>
                <code class="signature apipage">solid : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">whether or not this is an outline or a solid filled ngon</span><br/><span class="member apipage">
                <a name="sides"><a class="lift" href="#sides">sides</a></a><div class="clear"></div>
                <code class="signature apipage">sides : [Null](http://api.haxe.org/Null.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The number of sides. For a triangle, 3. For a square, 4, etc.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the radius of the ngon,
        around the center point x,y</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the batcher to add this geometry to (unless no_batcher_add). If not specified, the default batcher is used.</span><br/><span class="member apipage">
                <a name="angle"><a class="lift" href="#angle">angle</a></a><div class="clear"></div>
                <code class="signature apipage">angle : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat">an offset rotation angle in degrees</span><br/>
