...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not the geometry is visible or not. default: true</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The text string. default:`''`</span><br/><span class="member apipage">
                <a name="size"><a class="lift" href="#size">size</a></a><div class="clear"></div>
                <code class="signature apipage">size : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The text point size. WIP:see #98.
            This is falling away in favor of point_size for clarity and future options. default: font point size</span><br/><span class="member apipage">
                <a name="pos"><a class="lift" href="#pos">pos</a></a><div class="clear"></div>
                <code class="signature apipage">pos : [luxe.Vector](../../../api/luxe/Vector.html)</code><br/></span>
            <span class="small_desc_flat">The position of the text.
            If pos and bounds are specified, overrides the bounds x and y position. default:0,0</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The text point size. default: font point size</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Parent of this text</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Don't add to any scene</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">WIP STUFF this doesn't belong here but is added
        for compliance with existing api while refactoring for alpha-1.0</span><br/><span class="member apipage">
                <a name="locked"><a class="lift" href="#locked">locked</a></a><div class="clear"></div>
                <code class="signature apipage">locked : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Whether or not the geometry is locked or not. default: false</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not the geometry is immediate or not. default: false</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The geometry group id. default: 0</span><br/><span class="member apipage">
                <a name="geometry"><a class="lift" href="#geometry">geometry</a></a><div class="clear"></div>
                <code class="signature apipage">geometry : [phoenix.geometry.CompositeGeometry](../../../api/phoenix/geometry/CompositeGeometry.html)</code><br/></span>
            <span class="small_desc_flat">The geometry to append the text geometry to. WIP:see #98</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The font to use for drawing</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The geometry depth. default: 0.0</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The text color. default: white</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The bounding box for the text to align to.
            If pos and bounds are specified, the bounds size will be used
            but the position will override the bounds x and y. default:ignored</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The batcher to put the geometry in. default:Luxe.renderer.batcher</span><br/><span class="member apipage">
                <a name="align_vertical"><a class="lift" href="#align_vertical">align\_vertical</a></a><div class="clear"></div>
                <code class="signature apipage">align\_vertical : [phoenix.TextAlign](../../../api/phoenix/TextAlign.html)</code><br/></span>
            <span class="small_desc_flat">The vertical alignment to use when bounds are specified. default: top</span><br/><span class="member apipage">
                <a name="align"><a class="lift" href="#align">align</a></a><div class="clear"></div>
                <code class="signature apipage">align : [phoenix.TextAlign](../../../api/phoenix/TextAlign.html)</code><br/></span>
            <span class="small_desc_flat">The horizontal alignment to use.
            If bounds are specified, relative to the bounds, otherwise to the pos. default: left</span><br/>
