...
<span class="method apipage">
            ...
            <code class="signature apipage">schedule(\_time\_in\_seconds:[Float](http://api.haxe.org/Float.html)<span></span>, \_on\_time:[Dynamic](#)<span></span>, repeat:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [snow.api.Timer](#)</code><br/><span class="small_desc_flat"></span>
