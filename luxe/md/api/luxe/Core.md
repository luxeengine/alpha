...
meta: @:directlyUsed, @:keep, @:noCompletion, @:log_as(&quot;luxe&quot;)</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">ongamepaddevice(gamepad:[Int](http://api.haxe.org/Int.html)<span></span>, id:[String](http://api.haxe.org/String.html)<span></span>, type:[snow.types.GamepadDeviceEventType](#)<span></span>, timestamp:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">ontickend() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="ontickstart"><a class="lift" href="#ontickstart">ontickstart</a></a><div class="clear"></div>
            <code class="signature apipage">ontickstart() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
