...
<span class="method apipage">
            ...
            <code class="signature apipage">set\_paused(\_pause:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat"></span>
