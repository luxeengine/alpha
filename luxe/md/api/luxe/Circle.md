...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_x:[Float](http://api.haxe.org/Float.html)<span>=0</span>, \_y:[Float](http://api.haxe.org/Float.html)<span>=0</span>, \_r:[Float](http://api.haxe.org/Float.html)<span>=0</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">set(\_x:[Float](http://api.haxe.org/Float.html)<span>=null</span>, \_y:[Float](http://api.haxe.org/Float.html)<span>=null</span>, \_r:[Float](http://api.haxe.org/Float.html)<span>=null</span>) : [phoenix.Circle](../../api/phoenix/Circle.html)</code><br/><span class="small_desc_flat"></span>
