...
<h1>Parcel</h1>
<small>`luxe.Parcel` defined in ``</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The id of this `Parcel`.</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">list : [luxe.ParcelList](../../api/luxe/ParcelList.html)</code><br/></span>
            <span class="small_desc_flat">The list of the resource infos within this parcel, used at load/unload time.</span><br/><span class="member apipage">
                <a name="loaded"><a class="lift" href="#loaded">loaded</a></a><div class="clear"></div>
                <code class="signature apipage">loaded : [Array](http://api.haxe.org/Array.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">A list of resource ids that are loaded in this parcel, i.e that have a reference to the resource id</span><br/><span class="member apipage">
                <a name="state"><a class="lift" href="#state">state</a></a><div class="clear"></div>
                <code class="signature apipage">state : [luxe.ParcelState](../../api/luxe/ParcelState.html)</code><br/></span>
            <span class="small_desc_flat">The current parcel state.
            Set to unloaded by default,
            changed to loading when calling `load`,
            changed to loaded when complete,
            changed to unloaded when `unload` completes</span><br/><span class="member apipage">
                <a name="system"><a class="lift" href="#system">system</a></a><div class="clear"></div>
                <code class="signature apipage">system : [luxe.Resources](../../api/luxe/Resources.html)</code><br/></span>
            <span class="small_desc_flat">The parent Resources system this Parcel is contained by.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The time in seconds the last load took</span><br/>
...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">Return the number of resources listed in this Parcel</span><span class="member apipage">
                <a name="listed"><a class="lift" href="#listed">listed</a></a><div class="clear"></div>
                <code class="signature apipage">listed : [Array](http://api.haxe.org/Array.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">A list of resource ids that are known to this parcel</span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="emit"><a class="lift" href="#emit">emit</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">emit&lt;T&gt;(ev:[luxe.ParcelEvent](../../api/luxe/ParcelEvent.html)<span></span>, data:[emit.T](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            <a name="is_loaded"><a class="lift" href="#is_loaded">is\_loaded</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">is\_loaded(\_id:[String](http://api.haxe.org/String.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="load"><a class="lift" href="#load">load</a></a><div class="clear"></div>
            <code class="signature apipage">load(\_load\_id:[String](http://api.haxe.org/String.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Load this parcel contents with the optional load id, which is added to events.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">off&lt;T&gt;(ev:[luxe.ParcelEvent](../../api/luxe/ParcelEvent.html)<span></span>, handler:[off.T](#)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="on"><a class="lift" href="#on">on</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">on&lt;T&gt;(ev:[luxe.ParcelEvent](../../api/luxe/ParcelEvent.html)<span></span>, handler:[on.T](#)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="unload"><a class="lift" href="#unload">unload</a></a><div class="clear"></div>
            <code class="signature apipage">unload(\_empty\_list:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Unload this parcel contents, telling the system to remove the reference we have to them.
            Optionally the list can be emptied out, but will be kept around for reloading the parcel again.</span>
