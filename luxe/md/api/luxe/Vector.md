...
<span class="method apipage">
            ...
            <code class="signature apipage">add\_xyz(\_x:[Float](http://api.haxe.org/Float.html)<span>=0</span>, \_y:[Float](http://api.haxe.org/Float.html)<span>=0</span>, \_z:[Float](http://api.haxe.org/Float.html)<span>=0</span>) : [phoenix.Vector](../../api/phoenix/Vector.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">divide\_xyz(\_x:[Float](http://api.haxe.org/Float.html)<span>=1</span>, \_y:[Float](http://api.haxe.org/Float.html)<span>=1</span>, \_z:[Float](http://api.haxe.org/Float.html)<span>=1</span>) : [phoenix.Vector](../../api/phoenix/Vector.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">multiply\_xyz(\_x:[Float](http://api.haxe.org/Float.html)<span>=1</span>, \_y:[Float](http://api.haxe.org/Float.html)<span>=1</span>, \_z:[Float](http://api.haxe.org/Float.html)<span>=1</span>) : [phoenix.Vector](../../api/phoenix/Vector.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">setEulerFromQuaternion(q:[phoenix.Quaternion](../../api/phoenix/Quaternion.html)<span></span>, order:[phoenix.ComponentOrder](../../api/phoenix/ComponentOrder.html)<span>=0</span>) : [phoenix.Vector](../../api/phoenix/Vector.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">setEulerFromRotationMatrix(m:[phoenix.Matrix](../../api/phoenix/Matrix.html)<span></span>, order:[phoenix.ComponentOrder](../../api/phoenix/ComponentOrder.html)<span>=0</span>) : [phoenix.Vector](../../api/phoenix/Vector.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">subtract\_xyz(\_x:[Float](http://api.haxe.org/Float.html)<span>=0</span>, \_y:[Float](http://api.haxe.org/Float.html)<span>=0</span>, \_z:[Float](http://api.haxe.org/Float.html)<span>=0</span>) : [phoenix.Vector](../../api/phoenix/Vector.html)</code><br/><span class="small_desc_flat"></span>
