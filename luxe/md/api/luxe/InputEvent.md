...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">the type of input this event was generated for</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">touch\_event : [Null](http://api.haxe.org/Null.html)&lt;[luxe.TouchEvent](../../api/luxe/TouchEvent.html)&gt;</code><br/></span>
            ...
            <span class="small_desc_flat">the name of the input event</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">mouse\_event : [Null](http://api.haxe.org/Null.html)&lt;[luxe.MouseEvent](../../api/luxe/MouseEvent.html)&gt;</code><br/></span>
            <span class="small_desc_flat">null, unless type is `mouse`</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">key\_event : [Null](http://api.haxe.org/Null.html)&lt;[luxe.KeyEvent](../../api/luxe/KeyEvent.html)&gt;</code><br/></span>
            <span class="small_desc_flat">null, unless type is `keys`</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">gamepad\_event : [Null](http://api.haxe.org/Null.html)&lt;[luxe.GamepadEvent](../../api/luxe/GamepadEvent.html)&gt;</code><br/></span>
