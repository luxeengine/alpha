...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="bresenhamLine"><a class="lift" href="#bresenhamLine">bresenhamLine</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">bresenhamLine(start:[luxe.Vector](../../../../api/luxe/Vector.html)<span></span>, end:[luxe.Vector](../../../../api/luxe/Vector.html)<span></span>) : [Array](http://api.haxe.org/Array.html)&lt;[luxe.Vector](../../../../api/luxe/Vector.html)&gt;</code><br/><span class="small_desc_flat">Internal api - generate a bresenham line between given start and end points</span>


</span>
<span class="method apipage">
            <a name="testCircleVsCircle"><a class="lift" href="#testCircleVsCircle">testCircleVsCircle</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">testCircleVsCircle(circle1:[luxe.collision.shapes.Circle](../../../../api/luxe/collision/shapes/Circle.html)<span></span>, circle2:[luxe.collision.shapes.Circle](../../../../api/luxe/collision/shapes/Circle.html)<span></span>) : [luxe.collision.data.ShapeCollision](../../../../api/luxe/collision/data/ShapeCollision.html)</code><br/><span class="small_desc_flat">Internal api - test a circle against a circle</span>


</span>
<span class="method apipage">
            <a name="testCircleVsPolygon"><a class="lift" href="#testCircleVsPolygon">testCircleVsPolygon</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">testCircleVsPolygon(circle:[luxe.collision.shapes.Circle](../../../../api/luxe/collision/shapes/Circle.html)<span></span>, polygon:[luxe.collision.shapes.Polygon](../../../../api/luxe/collision/shapes/Polygon.html)<span></span>, flip:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [luxe.collision.data.ShapeCollision](../../../../api/luxe/collision/data/ShapeCollision.html)</code><br/><span class="small_desc_flat">Internal api - test a circle against a polygon</span>


</span>
<span class="method apipage">
            <a name="testPolygonVsPolygon"><a class="lift" href="#testPolygonVsPolygon">testPolygonVsPolygon</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">testPolygonVsPolygon(polygon1:[luxe.collision.shapes.Polygon](../../../../api/luxe/collision/shapes/Polygon.html)<span></span>, polygon2:[luxe.collision.shapes.Polygon](../../../../api/luxe/collision/shapes/Polygon.html)<span></span>, flip:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [luxe.collision.data.ShapeCollision](../../../../api/luxe/collision/data/ShapeCollision.html)</code><br/><span class="small_desc_flat">Internal api - test a polygon against another polygon</span>


</span>
<span class="method apipage">
            <a name="testRayVsCircle"><a class="lift" href="#testRayVsCircle">testRayVsCircle</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">testRayVsCircle(ray:[luxe.collision.shapes.Ray](../../../../api/luxe/collision/shapes/Ray.html)<span></span>, circle:[luxe.collision.shapes.Circle](../../../../api/luxe/collision/shapes/Circle.html)<span></span>) : [luxe.collision.data.RayCollision](../../../../api/luxe/collision/data/RayCollision.html)</code><br/><span class="small_desc_flat">Internal api - test a ray against a circle</span>


</span>
<span class="method apipage">
            <a name="testRayVsPolygon"><a class="lift" href="#testRayVsPolygon">testRayVsPolygon</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">testRayVsPolygon(ray:[luxe.collision.shapes.Ray](../../../../api/luxe/collision/shapes/Ray.html)<span></span>, polygon:[luxe.collision.shapes.Polygon](../../../../api/luxe/collision/shapes/Polygon.html)<span></span>) : [luxe.collision.data.RayCollision](../../../../api/luxe/collision/data/RayCollision.html)</code><br/><span class="small_desc_flat">Internal api - test a ray against a polygon</span>


</span>
<span class="method apipage">
            <a name="testRayVsRay"><a class="lift" href="#testRayVsRay">testRayVsRay</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">testRayVsRay(ray1:[luxe.collision.shapes.Ray](../../../../api/luxe/collision/shapes/Ray.html)<span></span>, ray2:[luxe.collision.shapes.Ray](../../../../api/luxe/collision/shapes/Ray.html)<span></span>) : [luxe.collision.data.RayIntersection](../../../../api/luxe/collision/data/RayIntersection.html)</code><br/><span class="small_desc_flat">Internal api - test a ray against another ray</span>
