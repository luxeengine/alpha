...
<span class="method apipage">
            ...
            <code class="signature apipage">drawLine(p0x:[Float](http://api.haxe.org/Float.html)<span></span>, p0y:[Float](http://api.haxe.org/Float.html)<span></span>, p1x:[Float](http://api.haxe.org/Float.html)<span></span>, p1y:[Float](http://api.haxe.org/Float.html)<span></span>, startPoint:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Draw a line between p0 and p1. Implement this function at minimum in custom drawing handlers</span>


</span>
<span class="method apipage">
            <a name="drawPoint"><a class="lift" href="#drawPoint">drawPoint</a></a><div class="clear"></div>
            <code class="signature apipage">drawPoint(x:[Float](http://api.haxe.org/Float.html)<span></span>, y:[Float](http://api.haxe.org/Float.html)<span></span>, size:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">drawShapeCollision(c:[luxe.collision.data.ShapeCollision](../../../api/luxe/collision/data/ShapeCollision.html)<span></span>, length:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
