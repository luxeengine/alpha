...
<span class="method apipage">
            ...
            <code class="signature apipage">drawShape(shape:[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)<span></span>, color:[luxe.Color](../../../api/luxe/Color.html)<span>=null</span>, immediate:[Bool](http://api.haxe.org/Bool.html)<span>=false</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Draw a `Shape`, it will determine the type and draw it for you.</span>
