...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="total"><a class="lift" href="#total">total</a></a><div class="clear"></div>
                <code class="signature apipage">total : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat"></span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="clear"><a class="lift" href="#clear">clear</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">clear() : [luxe.collision.Results](../../../api/luxe/collision/Results.html)&lt;[luxe.collision.Results.T](../../../api/luxe/collision/Results/T.html)&gt;</code><br/><span class="small_desc_flat">Clear the container, which sets the length to 0. 
            This keeps the cached items but won't return them 
            while iterating or accessing them.
            Returns `this` for convience.</span>


</span>
<span class="method apipage">
            <a name="get"><a class="lift" href="#get">get</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">get(index:[Int](http://api.haxe.org/Int.html)<span></span>) : [luxe.collision.Results.T](../../../api/luxe/collision/Results/T.html)</code><br/><span class="small_desc_flat">Get the item at the given index. 
            If the index is < 0 and > length-1 it returns null;</span>


</span>
<span class="method apipage">
            <a name="iterator"><a class="lift" href="#iterator">iterator</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">iterator() : [luxe.collision.ResultsIterator](../../../api/luxe/collision/ResultsIterator.html)&lt;[luxe.collision.Results.T](../../../api/luxe/collision/Results/T.html)&gt;</code><br/><span class="small_desc_flat">Returns an iterator over the valid items in this set.</span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(size:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Create a new set of results. 
            Preallocates `size` items into the list.</span>


</span>
<span class="method apipage">
            <a name="pull"><a class="lift" href="#pull">pull</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">pull() : [luxe.collision.Results.T](../../../api/luxe/collision/Results/T.html)</code><br/><span class="small_desc_flat">Grabs the last item from the cache to reuse.
            If there are no free items, it adds a new one.
            Typically internal use.</span>


</span>
<span class="method apipage">
            <a name="push"><a class="lift" href="#push">push</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">push(value:[luxe.collision.Results.T](../../../api/luxe/collision/Results/T.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Add an item to the container.</span>
