...
<span class="method apipage">
            ...
            <code class="signature apipage">drawLine(p0:[luxe.Vector](../../../api/luxe/Vector.html)<span></span>, p1:[luxe.Vector](../../../api/luxe/Vector.html)<span></span>, startPoint:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
