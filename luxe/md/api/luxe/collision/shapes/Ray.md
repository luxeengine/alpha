...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">end : [luxe.Vector](../../../../api/luxe/Vector.html)</code><br/></span>
            <span class="small_desc_flat">The end point of the ray.</span><br/><span class="member apipage">
                <a name="infinite"><a class="lift" href="#infinite">infinite</a></a><div class="clear"></div>
                <code class="signature apipage">infinite : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat">Whether or not the ray is infinite.</span><br/><span class="member apipage">
                <a name="start"><a class="lift" href="#start">start</a></a><div class="clear"></div>
                <code class="signature apipage">start : [luxe.Vector](../../../../api/luxe/Vector.html)</code><br/></span>
            <span class="small_desc_flat">The start point of the ray.</span><br/>

<h3>Properties</h3> <hr/><span class="member apipage">
                <a name="dir"><a class="lift" href="#dir">dir</a></a><div class="clear"></div>
                <code class="signature apipage">dir : [luxe.Vector](../../../../api/luxe/Vector.html)</code><br/></span>
            <span class="small_desc_flat">The direction of the ray.
            Returns a cached vector, so modifying it will affect this instance.
            Updates only when the dir value is accessed.</span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_start:[luxe.Vector](../../../../api/luxe/Vector.html)<span></span>, \_end:[luxe.Vector](../../../../api/luxe/Vector.html)<span></span>, \_infinite:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Create a new ray with the start and end point,
            which determine the direction of the ray, and optionally specifying
            that this ray is an infinite one.</span>
