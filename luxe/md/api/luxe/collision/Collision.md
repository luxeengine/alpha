...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">pointInPoly(x:[Float](http://api.haxe.org/Float.html)<span></span>, y:[Float](http://api.haxe.org/Float.html)<span></span>, poly:[luxe.collision.shapes.Polygon](../../../api/luxe/collision/shapes/Polygon.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">Test if a given point lands inside the given polygon.
            Returns true if it does, false otherwise.</span>


</span>
<span class="method apipage">
            <a name="rayWithRay"><a class="lift" href="#rayWithRay">rayWithRay</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">rayWithRay(ray1:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>, ray2:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>, into:[luxe.collision.data.RayIntersection](../../../api/luxe/collision/data/RayIntersection.html)<span></span>) : [luxe.collision.data.RayIntersection](../../../api/luxe/collision/data/RayIntersection.html)</code><br/><span class="small_desc_flat">Test a ray against another ray.
            When no collision is found, this function returns null.
            Returns a `RayIntersection` if a collision is found.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">rayWithRays(ray:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>, rays:[Array](http://api.haxe.org/Array.html)&lt;[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)&gt;<span></span>, into:[Null](http://api.haxe.org/Null.html)&lt;[luxe.collision.Results_luxe_collision_data_RayIntersection](../../../api/luxe/collision/Results_luxe_collision_data_RayIntersection.html)&gt;<span></span>) : [luxe.collision.Results_luxe_collision_data_RayIntersection](../../../api/luxe/collision/Results_luxe_collision_data_RayIntersection.html)</code><br/><span class="small_desc_flat">Test a ray against a list of other rays.
            ...
            `for(result in results) {  result... }`</span>


</span>
<span class="method apipage">
            <a name="rayWithShape"><a class="lift" href="#rayWithShape">rayWithShape</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">rayWithShape(ray:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>, shape:[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)<span></span>, into:[luxe.collision.data.RayCollision](../../../api/luxe/collision/data/RayCollision.html)<span></span>) : [luxe.collision.data.RayCollision](../../../api/luxe/collision/data/RayCollision.html)</code><br/><span class="small_desc_flat">Test a line between two points against a list of shapes.
            When no collision is found, this function returns null.
            Returns a `RayCollision` if a collision is found.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">rayWithShapes(ray:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>, shapes:[Array](http://api.haxe.org/Array.html)&lt;[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)&gt;<span></span>, into:[Null](http://api.haxe.org/Null.html)&lt;[luxe.collision.Results_luxe_collision_data_RayCollision](../../../api/luxe/collision/Results_luxe_collision_data_RayCollision.html)&gt;<span></span>) : [luxe.collision.Results_luxe_collision_data_RayCollision](../../../api/luxe/collision/Results_luxe_collision_data_RayCollision.html)</code><br/><span class="small_desc_flat">Test a ray between two points against a list of shapes.
            When no collision is found, this function returns an empty array, this function will never return null.
...
<span class="method apipage">
            <a name="shapeWithShape"><a class="lift" href="#shapeWithShape">shapeWithShape</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">shapeWithShape(shape1:[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)<span></span>, shape2:[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)<span></span>, into:[luxe.collision.data.ShapeCollision](../../../api/luxe/collision/data/ShapeCollision.html)<span></span>) : [luxe.collision.data.ShapeCollision](../../../api/luxe/collision/data/ShapeCollision.html)</code><br/><span class="small_desc_flat">Test a single shape against another shape.
            When no collision is found between them, this function returns null.
            Returns a `ShapeCollision` if a collision is found.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">shapeWithShapes(shape1:[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)<span></span>, shapes:[Array](http://api.haxe.org/Array.html)&lt;[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)&gt;<span></span>, into:[Null](http://api.haxe.org/Null.html)&lt;[luxe.collision.Results_luxe_collision_data_ShapeCollision](../../../api/luxe/collision/Results_luxe_collision_data_ShapeCollision.html)&gt;<span></span>) : [luxe.collision.Results_luxe_collision_data_ShapeCollision](../../../api/luxe/collision/Results_luxe_collision_data_ShapeCollision.html)</code><br/><span class="small_desc_flat">Test a single shape against multiple other shapes.
