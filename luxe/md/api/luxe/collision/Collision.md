...
<h1>Collision</h1>
<small>`luxe.collision.Collision` defined in ``</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">pointInPoly(point:[luxe.Vector](../../../api/luxe/Vector.html)<span></span>, poly:[luxe.collision.shapes.Polygon](../../../api/luxe/collision/shapes/Polygon.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">Test if a given point lands inside the given polygon.
...
<span class="method apipage">
            ...
            <code class="signature apipage">rayWithRay(ray1:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>, ray2:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>) : [luxe.collision.data.RayIntersection](../../../api/luxe/collision/data/RayIntersection.html)</code><br/><span class="small_desc_flat">Test a ray against another ray.
...
<span class="method apipage">
            ...
            <code class="signature apipage">rayWithRays(ray:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>, rays:[Array](http://api.haxe.org/Array.html)&lt;[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)&gt;<span></span>) : [Array](http://api.haxe.org/Array.html)&lt;[luxe.collision.data.RayIntersection](../../../api/luxe/collision/data/RayIntersection.html)&gt;</code><br/><span class="small_desc_flat">Test a ray against a list of other rays.
            When no collision is found, this function returns an empty array, this function will never return null.
            Returns a list of `RayIntersection` information for each collision found.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">rayWithShape(ray:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>, shape:[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)<span></span>) : [luxe.collision.data.RayCollision](../../../api/luxe/collision/data/RayCollision.html)</code><br/><span class="small_desc_flat">Test a line between two points against a list of shapes.
            When no collision is found, this function returns null.
...
<span class="method apipage">
            ...
            <code class="signature apipage">rayWithShapes(ray:[luxe.collision.shapes.Ray](../../../api/luxe/collision/shapes/Ray.html)<span></span>, shapes:[Array](http://api.haxe.org/Array.html)&lt;[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)&gt;<span></span>) : [Array](http://api.haxe.org/Array.html)&lt;[luxe.collision.data.RayCollision](../../../api/luxe/collision/data/RayCollision.html)&gt;</code><br/><span class="small_desc_flat">Test a ray between two points against a list of shapes.
            When no collision is found, this function returns an empty array, this function will never return null.
            Returns a list of `RayCollision` information for each collision found.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">shapeWithShape(shape1:[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)<span></span>, shape2:[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)<span></span>) : [luxe.collision.data.ShapeCollision](../../../api/luxe/collision/data/ShapeCollision.html)</code><br/><span class="small_desc_flat">Test a single shape against another shape.
...
<span class="method apipage">
            ...
            <code class="signature apipage">shapeWithShapes(shape1:[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)<span></span>, shapes:[Array](http://api.haxe.org/Array.html)&lt;[luxe.collision.shapes.Shape](../../../api/luxe/collision/shapes/Shape.html)&gt;<span></span>) : [Array](http://api.haxe.org/Array.html)&lt;[luxe.collision.data.ShapeCollision](../../../api/luxe/collision/data/ShapeCollision.html)&gt;</code><br/><span class="small_desc_flat">Test a single shape against multiple other shapes.
            When no collision is found, this function returns an empty array, this function will never return null.
            Returns a list of `ShapeCollision` information for each collision found.</span>
