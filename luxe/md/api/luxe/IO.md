...
<h1>IO</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/IO.hx">luxe.IO</a></code>
</small>
...
<h3>Properties</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">app\_path : [String](http://api.haxe.org/String.html)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="app_path_prefs"><a class="lift" href="#app_path_prefs">app\_path\_prefs</a></a><div class="clear"></div>
                <code class="signature apipage">app\_path\_prefs : [String](http://api.haxe.org/String.html)</code><br/></span>
            <span class="small_desc_flat"></span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="string_destroy"><a class="lift" href="#string_destroy">string\_destroy</a></a><span class="inline-block static">inline</span><div class="clear"></div>
...
<span class="method apipage">
            <a name="string_load"><a class="lift" href="#string_load">string\_load</a></a><span class="inline-block static">inline</span><div class="clear"></div>
...
<span class="method apipage">
            <a name="string_save"><a class="lift" href="#string_save">string\_save</a></a><span class="inline-block static">inline</span><div class="clear"></div>
...
<span class="method apipage">
            <a name="url_open"><a class="lift" href="#url_open">url\_open</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">url\_open(\_url:[String](http://api.haxe.org/String.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Open the system default browser with the given URL.
            supported: mac/window/linux/iOS/web
            pending: android https://github.com/underscorediscovery/snow/issues/25</span>
