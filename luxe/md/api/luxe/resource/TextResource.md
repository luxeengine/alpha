...
<h1>TextResource</h1>
<small>`luxe.resource.TextResource`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">asset : [snow.system.assets.AssetText](#)</code><br/></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_options:[luxe.options.TextResourceOptions](../../../api/luxe/options/TextResourceOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
