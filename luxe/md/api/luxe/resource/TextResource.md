...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(\_id:[String](http://api.haxe.org/String.html)<span></span>, \_text:[String](http://api.haxe.org/String.html)<span></span>, \_manager:[luxe.resource.ResourceManager](../../../api/luxe/resource/ResourceManager.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
