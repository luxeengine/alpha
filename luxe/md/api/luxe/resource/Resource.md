...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                ...
                <code class="signature apipage">manager : [luxe.resource.ResourceManager](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="persistent"><a class="lift" href="#persistent">persistent</a></a><div class="clear"></div>
                <code class="signature apipage">persistent : [Bool](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="time_created"><a class="lift" href="#time_created">time\_created</a></a><div class="clear"></div>
                <code class="signature apipage">time\_created : [Float](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                ...
                <code class="signature apipage">type : [luxe.resource.ResourceType](#)</code><br/></span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
    ...
    <span class="method apipage">
            ...
            <code class="signature apipage">new(\_manager:[luxe.resource.ResourceManager](#)<span></span>, \_type:[luxe.resource.ResourceType](#)<span></span>, \_load\_time:[Float](#)<span>=null</span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
