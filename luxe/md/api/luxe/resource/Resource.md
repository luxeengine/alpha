...
<h1>Resource</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/resource/Resource.hx">luxe.resource.Resource</a></code>
</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            If not from disk, the id can be anything but must be unique to this resource.</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">resource\_type : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">The resource type ID. Defaults use ResourceType ids but is typed Int for user id's.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The resource system that contains this Resource.</span><br/>

<h3>Properties</h3> <hr/><span class="member apipage">
                <a name="ref"><a class="lift" href="#ref">ref</a></a><div class="clear"></div>
                <code class="signature apipage">ref : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">The reference count of this resource. Each time a
            ...
            This works via setter, so changing it with ref++ and ref-- is ok.</span><span class="member apipage">
                <a name="state"><a class="lift" href="#state">state</a></a><div class="clear"></div>
                <code class="signature apipage">state : [luxe.ResourceState](../../../api/luxe/ResourceState.html)</code><br/></span>
            <span class="small_desc_flat">The state this resource is currently in.</span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="destroy"><a class="lift" href="#destroy">destroy</a></a><div class="clear"></div>
            <code class="signature apipage">destroy(\_force:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Destroys the resource, unlisting it, cleaning up it's resource usage.
            ...
            To force destroying and ignore the ref counting, pass true for `force` flag.</span>


</span>
<span class="method apipage">
            <a name="invalidate"><a class="lift" href="#invalidate">invalidate</a></a><div class="clear"></div>
            <code class="signature apipage">invalidate() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Invalidates and frees up any resource usage held.
            The resource instance remains valid for use, and remains listed in the resource cache.</span>


</span>
<span class="method apipage">
            <a name="memory_use"><a class="lift" href="#memory_use">memory\_use</a></a><div class="clear"></div>
            <code class="signature apipage">memory\_use() : [Float](http://api.haxe.org/Float.html)</code><br/><span class="small_desc_flat">Returns the estimated memory use by this resource, in bytes.
            You can use Luxe.utils.bytes_to_string to display this value easily.
            Some resources return 0, in the case of not being able to give an estimate.</span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_options:[luxe.options.ResourceOptions](../../../api/luxe/options/ResourceOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="reload"><a class="lift" href="#reload">reload</a></a><div class="clear"></div>
            <code class="signature apipage">reload() : [snow.api.Promise](https://snowkit.github.io/snow/api/snow/api/Promise.html)</code><br/><span class="small_desc_flat">Returns a promise for the reloaded resource.
            Returns null from the base `Resource` type, implemented in subclasses.</span>
