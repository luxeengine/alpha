...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="geometry_quad"><a class="lift" href="#geometry_quad">geometry\_quad</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#geometry\_quad'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
...
<h3>Properties</h3> <hr/><span class="member apipage">
                <a name="centered"><a class="lift" href="#centered">centered</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#centered'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
                <code class="signature apipage">centered : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="clip_rect"><a class="lift" href="#clip_rect">clip\_rect</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#clip\_rect'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">If note null, the geometry will be clipped to this rectangle region (in world space).</span><span class="member apipage">
                <a name="color"><a class="lift" href="#color">color</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#color'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">the base color</span><span class="member apipage">
                <a name="depth"><a class="lift" href="#depth">depth</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#depth'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">the geometry depth value (see guides)</span><span class="member apipage">
                <a name="flipx"><a class="lift" href="#flipx">flipx</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#flipx'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
                <code class="signature apipage">flipx : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="flipy"><a class="lift" href="#flipy">flipy</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#flipy'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
                <code class="signature apipage">flipy : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="geometry"><a class="lift" href="#geometry">geometry</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#geometry'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">the geometry this visual contains</span><span class="member apipage">
                <a name="group"><a class="lift" href="#group">group</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#group'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">the geometry group id (see guides)</span><span class="member apipage">
                <a name="locked"><a class="lift" href="#locked">locked</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#locked'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">the geometry static flag. This is a hint on how to render the geometry for performance</span><span class="member apipage">
                <a name="radians"><a class="lift" href="#radians">radians</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#radians'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">convenience: controls the rotation around the z axis, in radians.</span><span class="member apipage">
                <a name="rotation_z"><a class="lift" href="#rotation_z">rotation\_z</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#rotation\_z'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">convenience: controls the rotation around the z axis, in degrees.</span><span class="member apipage">
                <a name="shader"><a class="lift" href="#shader">shader</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#shader'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">the shader for the geometry</span><span class="member apipage">
                <a name="size"><a class="lift" href="#size">size</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#size'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">the size of this geometry (only makes sense for QuadGeometry)</span><span class="member apipage">
                <a name="texture"><a class="lift" href="#texture">texture</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#texture'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            ...
            <span class="small_desc_flat">the texture for the geometry</span><span class="member apipage">
                <a name="uv"><a class="lift" href="#uv">uv</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#uv'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
                <code class="signature apipage">uv : [luxe.Rectangle](../../api/luxe/Rectangle.html)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="visible"><a class="lift" href="#visible">visible</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#visible'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
...
<span class="method apipage">
            <a name="init"><a class="lift" href="#init">init</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#init'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
...
<span class="method apipage">
            <a name="ondestroy"><a class="lift" href="#ondestroy">ondestroy</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#ondestroy'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">ondestroy() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="point_inside"><a class="lift" href="#point_inside">point\_inside</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#point\_inside'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
...
<span class="method apipage">
            <a name="point_inside_AABB"><a class="lift" href="#point_inside_AABB">point\_inside\_AABB</a></a><a data-tooltip="inherited from <a href='../../api/luxe/Sprite.html#point\_inside\_AABB'>luxe.Sprite</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
