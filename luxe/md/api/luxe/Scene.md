...
`class`extends <code><span><a href="../../api/luxe/Objects.html">luxe.Objects</a></span></code>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">whether or not this scene has been destroyed</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The list of entities within this `Scene`</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not the `Scene` has called init</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not the `Scene` has called reset</span><br/>
...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The number of entities in this `Scene`</span><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">add(entity:[luxe.Entity](../../api/luxe/Entity.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">empty() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Destroy all entities in this scene.
            ...
            but saves a lot of confusion for and improves workflow.</span>


</span>
<span class="method apipage">
            <a name="get"><a class="lift" href="#get">get</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">get&lt;T&gt;(\_name:[String](http://api.haxe.org/String.html)<span></span>) : [get.T](#)</code><br/><span class="small_desc_flat"></span>
