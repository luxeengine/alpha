...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The window id from which this event originated</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">type : [Null](http://api.haxe.org/Null.html)&lt;[luxe.WindowEventType](../../api/luxe/WindowEventType.html)&gt;</code><br/></span>
            ...
            <span class="small_desc_flat">The time in seconds that this event occured, useful for deltas</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">event : [Null](http://api.haxe.org/Null.html)&lt;[luxe.WindowEventData](../../api/luxe/WindowEventData.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The event data, where applicable. For example, with move, resized or sized events the data contains the new information as a result of the event.</span><br/>
