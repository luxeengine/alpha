...
`class`extends <code><span><a href="../../api/luxe/ID.html">luxe.ID</a></span></code>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="machine"><a class="lift" href="#machine">machine</a></a><div class="clear"></div>
                <code class="signature apipage">machine : [luxe.States](../../api/luxe/States.html)</code><br/></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">disable&lt;T&gt;(\_disable\_with:[disable.T](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="enable"><a class="lift" href="#enable">enable</a></a><div class="clear"></div>
            <code class="signature apipage">enable&lt;T&gt;(\_enable\_with:[enable.T](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_options:[luxe.options.StateOptions](../../api/luxe/options/StateOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
