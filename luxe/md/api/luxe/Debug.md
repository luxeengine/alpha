...
<span class="method apipage">
            ...
            <code class="signature apipage">start(\_name:[String](http://api.haxe.org/String.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">start a profiling section for the profiler debug view</span>
