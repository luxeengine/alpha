...
<h1>Debug</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/Debug.hx">luxe.Debug</a></code>
</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="inspector"><a class="lift" href="#inspector">inspector</a></a><div class="clear"></div>
                <code class="signature apipage">inspector : [luxe.debug.Inspector](../../api/luxe/debug/Inspector.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="trace_callbacks"><a class="lift" href="#trace_callbacks">trace\_callbacks</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">trace\_callbacks : [Array](http://api.haxe.org/Array.html)&lt;[](#)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
