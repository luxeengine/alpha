...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">cursor : [luxe.Cursor](../../api/luxe/Cursor.html)</code><br/></span>
            <span class="small_desc_flat">Access to the mouse cursor, position, visibility, locking etc.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Convenience: Returns the screen height as a Float</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Convenience: Returns the screen width as a Float</span><br/>
...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">Convenience: Returns *a new rectangle*, the bounds of the screen (0, 0, w, h)</span><span class="member apipage">
                <a name="device_pixel_ratio"><a class="lift" href="#device_pixel_ratio">device\_pixel\_ratio</a></a><div class="clear"></div>
                <code class="signature apipage">device\_pixel\_ratio : [Float](http://api.haxe.org/Float.html)</code><br/></span>
            <span class="small_desc_flat">Returns the screen device pixel ratio, a scaling factor for high DPI devices.
            Note that Luxe.screen (and the snow framework below it) only deals with real pixels, not device pixels.
            Luxe and snow only ever deal with drawable area in real pixels. Which is to say: If you need device pixels, you divide the real pixel size by this value.</span><span class="member apipage">
                <a name="h"><a class="lift" href="#h">h</a></a><div class="clear"></div>
                <code class="signature apipage">h : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">Returns the screen height as an Int</span><span class="member apipage">
                <a name="mid"><a class="lift" href="#mid">mid</a></a><div class="clear"></div>
                <code class="signature apipage">mid : [luxe.Vector](../../api/luxe/Vector.html)</code><br/></span>
            <span class="small_desc_flat">Convenience: Returns *a new vector*, the middle of the screen, rounded as (w/2, h/2)</span><span class="member apipage">
            ...
            <span class="small_desc_flat">Convenience: Returns *a new vector*, the size of the screen</span><span class="member apipage">
                <a name="w"><a class="lift" href="#w">w</a></a><div class="clear"></div>
                <code class="signature apipage">w : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">Returns the screen width as an Int</span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="point_inside"><a class="lift" href="#point_inside">point\_inside</a></a><div class="clear"></div>
            <code class="signature apipage">point\_inside(\_p:[luxe.Vector](../../api/luxe/Vector.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">Returns true if the given point falls within the bounds of the w/h of the screen.</span>


</span>
<span class="method apipage">
            <a name="point_inside_xy"><a class="lift" href="#point_inside_xy">point\_inside\_xy</a></a><div class="clear"></div>
            <code class="signature apipage">point\_inside\_xy(\_x:[Float](http://api.haxe.org/Float.html)<span></span>, \_y:[Float](http://api.haxe.org/Float.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">Returns true if the given point as floats fall within the bounds of the w/h of the screen.</span>
