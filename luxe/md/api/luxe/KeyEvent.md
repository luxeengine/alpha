...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The state of the key in this event</span><br/><span class="member apipage">
                <a name="scancode"><a class="lift" href="#scancode">scancode</a></a><div class="clear"></div>
                <code class="signature apipage">scancode : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">The `Scan` code value for this event</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">If this value is bigger than 0 this is a key repeat event of a key held down</span><br/><span class="member apipage">
                <a name="mod"><a class="lift" href="#mod">mod</a></a><div class="clear"></div>
                <code class="signature apipage">mod : [luxe.ModState](../../api/luxe/ModState.html)</code><br/></span>
            <span class="small_desc_flat">The modifier state of this event</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The `Key` code value for this event</span><br/>
