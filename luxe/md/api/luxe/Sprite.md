...
`class`extends <code><span><a href="../../api/luxe/Visual.html">luxe.Visual</a></span></code><br/><span class="meta">
...
<span class="method apipage">
            ...
            <code class="signature apipage">point\_inside(\_p:[luxe.Vector](../../api/luxe/Vector.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">Returns true if a point is inside the sprite, takes into account the sprite transform,
            which includes more cost than simple AABB like `point_inside_AABB`</span>
