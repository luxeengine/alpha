...
<h1>Visual</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/luxe/Visual.hx">luxe.Visual</a></code>
</small>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_options:[luxe.options.VisualOptions](../../api/luxe/options/VisualOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Create a new visual based on the given options</span>
