...
<span class="method apipage">
            ...
            <code class="signature apipage">new(options:[luxe.options.LuxeCameraOptions](../../api/luxe/options/LuxeCameraOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">create a new camera with the given options</span>
