...
`class`extends <code><span><a href="../../api/luxe/Entity.html">luxe.Entity</a></span></code><br/><span class="meta">
...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The virtual size of this camera. allows simple upscaling world coordinates, using `size_mode`. Note that this changes the view `scale` values and the `center` property.</span><span class="member apipage">
                <a name="size_mode"><a class="lift" href="#size_mode">size\_mode</a></a><div class="clear"></div>
...
<span class="method apipage">
            ...
            <code class="signature apipage">focus(\_p:[luxe.Vector](../../api/luxe/Vector.html)<span></span>, \_t:[Float](http://api.haxe.org/Float.html)<span></span>, \_oncomplete:[Dynamic](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Focus the camera on a specific point, for Ortho only.
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_options:[luxe.options.LuxeCameraOptions](../../api/luxe/options/LuxeCameraOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">create a new camera with the given options</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">shake(\_amount:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Shake the camera a given amount</span>
