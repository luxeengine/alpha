...
<h3>Methods</h3> <hr/><span class="method apipage">
    ...
    <span class="method apipage">
            ...
            <code class="signature apipage">dequeue(event\_id:[String](#)<span></span>) : [Bool](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
    ...
    <span class="method apipage">
            ...
            <code class="signature apipage">disconnect(event\_id:[String](#)<span></span>) : [Bool](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="does_filter_event"><a class="lift" href="#does_filter_event">does\_filter\_event</a></a><div class="clear"></div>
            <code class="signature apipage">does\_filter\_event(\_filter:[String](#)<span></span>, \_event:[String](#)<span></span>) : [Bool](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
    ...
    <span class="method apipage">
            ...
            <code class="signature apipage">listen&lt;T&gt;(\_event\_name:[String](#)<span></span>, \_listener:[listen.T](#)&nbsp;-&gt; [Void](#)<span></span>) : [String](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
