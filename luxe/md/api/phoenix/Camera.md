...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">cull\_backfaces : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="depth_test"><a class="lift" href="#depth_test">depth\_test</a></a><div class="clear"></div>
                <code class="signature apipage">depth\_test : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="ortho_bottom"><a class="lift" href="#ortho_bottom">ortho\_bottom</a></a><div class="clear"></div>
                <code class="signature apipage">ortho\_bottom : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="ortho_left"><a class="lift" href="#ortho_left">ortho\_left</a></a><div class="clear"></div>
                <code class="signature apipage">ortho\_left : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="ortho_right"><a class="lift" href="#ortho_right">ortho\_right</a></a><div class="clear"></div>
                <code class="signature apipage">ortho\_right : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="ortho_top"><a class="lift" href="#ortho_top">ortho\_top</a></a><div class="clear"></div>
                <code class="signature apipage">ortho\_top : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
