...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(\_screen\_pos:[phoenix.Vector](../../api/phoenix/Vector.html)<span></span>, \_camera:[phoenix.Camera](../../api/phoenix/Camera.html)<span></span>, \_viewport:[phoenix.Rectangle](../../api/phoenix/Rectangle.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
