...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">value : [phoenix.UniformValue.T](../../api/phoenix/UniformValue/T.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="type"><a class="lift" href="#type">type</a></a><div class="clear"></div>
                <code class="signature apipage">type : [phoenix.UniformValueType](../../api/phoenix/UniformValueType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">location : [snow.render.opengl.GLUniformLocation](#)</code><br/></span>
