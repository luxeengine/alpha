...
<h1>BlendEquation_Impl_</h1>
<small>`phoenix._Batcher.BlendEquation_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">add : [phoenix.BlendEquation](../../../api/phoenix/BlendEquation.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="reverse_subtract"><a class="lift" href="#reverse_subtract">reverse\_subtract</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">reverse\_subtract : [phoenix.BlendEquation](../../../api/phoenix/BlendEquation.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">subtract : [phoenix.BlendEquation](../../../api/phoenix/BlendEquation.html)</code><br/></span>
