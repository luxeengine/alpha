...
<span class="method apipage">
            ...
            <code class="signature apipage">set\_matrix4\_arr(\_name:[String](http://api.haxe.org/String.html)<span></span>, \_value:[snow.api.buffers.Float32Array](#)<span></span>, \_location:[phoenix._Shader.Location](../../api/phoenix/_Shader/Location.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
