...
<span class="method apipage">
            <a name="load_from_bytearray"><a class="lift" href="#load_from_bytearray">load\_from\_bytearray</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">load\_from\_bytearray(\_name:[String](http://api.haxe.org/String.html)<span></span>, \_bytes:[snow.utils.ByteArray](#)<span></span>, \_cache:[Bool](http://api.haxe.org/Bool.html)<span>=true</span>) : [phoenix.Texture](../../api/phoenix/Texture.html)</code><br/><span class="small_desc_flat">create and load a texture from a ByteArray. Take note this accepts image formats, not raw pixels/bytes.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">load\_from\_pixels(\_id:[String](http://api.haxe.org/String.html)<span></span>, \_width:[Int](http://api.haxe.org/Int.html)<span></span>, \_height:[Int](http://api.haxe.org/Int.html)<span></span>, \_pixels:[snow.utils.UInt8Array](#)<span></span>, \_cache:[Bool](http://api.haxe.org/Bool.html)<span>=true</span>) : [phoenix.Texture](../../api/phoenix/Texture.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">load\_from\_resource(\_name:[String](http://api.haxe.org/String.html)<span></span>, \_cache:[Bool](http://api.haxe.org/Bool.html)<span>=true</span>) : [phoenix.Texture](../../api/phoenix/Texture.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_manager:[luxe.resource.ResourceManager](../../api/luxe/resource/ResourceManager.html)<span></span>, \_type:[luxe.resource.ResourceType](../../api/luxe/resource/ResourceType.html)<span>=null</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
