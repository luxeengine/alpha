...
<span class="method apipage">
            ...
            <code class="signature apipage">empty(\_drop:[Bool](http://api.haxe.org/Bool.html)<span>=true</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">:todo: this is a temporary construct as part of #119</span>
