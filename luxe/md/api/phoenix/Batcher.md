...
meta: @:allow(phoenix.Renderer)</span>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="color_attribute"><a class="lift" href="#color_attribute">color\_attribute</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">color\_attribute : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="color_list"><a class="lift" href="#color_list">color\_list</a></a><div class="clear"></div>
                <code class="signature apipage">color\_list : [snow.api.buffers.Float32Array](https://snowkit.github.io/snow/api/snow/api/buffers/Float32Array.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">emitter : [luxe.Emitter](../../api/luxe/Emitter.html)&lt;[phoenix.BatcherEventType](../../api/phoenix/BatcherEventType.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="normal_attribute"><a class="lift" href="#normal_attribute">normal\_attribute</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">normal\_attribute : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="normal_list"><a class="lift" href="#normal_list">normal\_list</a></a><div class="clear"></div>
                <code class="signature apipage">normal\_list : [snow.api.buffers.Float32Array](https://snowkit.github.io/snow/api/snow/api/buffers/Float32Array.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="pos_list"><a class="lift" href="#pos_list">pos\_list</a></a><div class="clear"></div>
                <code class="signature apipage">pos\_list : [snow.api.buffers.Float32Array](https://snowkit.github.io/snow/api/snow/api/buffers/Float32Array.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="tcoord_attribute"><a class="lift" href="#tcoord_attribute">tcoord\_attribute</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">tcoord\_attribute : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="tcoord_list"><a class="lift" href="#tcoord_list">tcoord\_list</a></a><div class="clear"></div>
                <code class="signature apipage">tcoord\_list : [snow.api.buffers.Float32Array](https://snowkit.github.io/snow/api/snow/api/buffers/Float32Array.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="vert_attribute"><a class="lift" href="#vert_attribute">vert\_attribute</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
...
<span class="method apipage">
            ...
            <code class="signature apipage">destroy(\_drop:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Destroy this batcher.
            Drops all the geometry within it (empty).
            Removes itself from the renderer.
            Does not change the `view`.
            Do not use the batcher instance after calling this.</span>


</span>
<span class="method apipage">
            <a name="draw"><a class="lift" href="#draw">draw</a></a><span class="inline-block static">inline</span><div class="clear"></div>
...
<span class="method apipage">
            ...
            <code class="signature apipage">empty(\_drop:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Drop all the geometry within this batcher, emptying it out.</span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_r:[phoenix.Renderer](../../api/phoenix/Renderer.html)<span></span>, \_name:[String](http://api.haxe.org/String.html)<span></span>, \_max\_verts:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="off"><a class="lift" href="#off">off</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">off(event:[phoenix.BatcherEventType](../../api/phoenix/BatcherEventType.html)<span></span>, handler:[phoenix.Batcher](../../api/phoenix/Batcher.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="on"><a class="lift" href="#on">on</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">on(event:[phoenix.BatcherEventType](../../api/phoenix/BatcherEventType.html)<span></span>, handler:[phoenix.Batcher](../../api/phoenix/Batcher.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
