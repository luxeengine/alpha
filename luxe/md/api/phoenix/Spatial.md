...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="auto_decompose"><a class="lift" href="#auto_decompose">auto\_decompose</a></a><div class="clear"></div>
                <code class="signature apipage">auto\_decompose : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="floats"><a class="lift" href="#floats">floats</a></a><div class="clear"></div>
                <code class="signature apipage">floats : [snow.api.buffers.Float32Array](https://snowkit.github.io/snow/api/snow/api/buffers/Float32Array.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<h3>Properties</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">matrix : [phoenix.Matrix](../../api/phoenix/Matrix.html)</code><br/></span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">decompose(\_force:[Bool](http://api.haxe.org/Bool.html)<span></span>) : [phoenix.Spatial](../../api/phoenix/Spatial.html)</code><br/><span class="small_desc_flat"></span>
