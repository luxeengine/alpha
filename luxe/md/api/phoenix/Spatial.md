...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">decompose(\_force:[Bool](http://api.haxe.org/Bool.html)<span>=true</span>) : [phoenix.Spatial](../../api/phoenix/Spatial.html)</code><br/><span class="small_desc_flat"></span>
