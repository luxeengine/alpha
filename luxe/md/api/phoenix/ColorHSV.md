...
<h1>ColorHSV</h1>
<small>
<code>phoenix.ColorHSV</code> defined in <code><a href="https:/github.com/underscorediscovery/luxe/blob/master/phoenix/Color.hx" target="_blank">phoenix.Color</a></code>
</small>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_h:[Float](http://api.haxe.org/Float.html)<span></span>, \_s:[Float](http://api.haxe.org/Float.html)<span></span>, \_v:[Float](http://api.haxe.org/Float.html)<span></span>, \_a:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="set"><a class="lift" href="#set">set</a></a><div class="clear"></div>
            <code class="signature apipage">set(\_h:[Float](http://api.haxe.org/Float.html)<span></span>, \_s:[Float](http://api.haxe.org/Float.html)<span></span>, \_v:[Float](http://api.haxe.org/Float.html)<span></span>, \_a:[Float](http://api.haxe.org/Float.html)<span></span>) : [phoenix.Color](../../api/phoenix/Color.html)</code><br/><span class="small_desc_flat"></span>
