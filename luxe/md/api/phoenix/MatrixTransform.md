...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(p:[phoenix.Vector](../../api/phoenix/Vector.html)<span></span>, r:[phoenix.Quaternion](../../api/phoenix/Quaternion.html)<span></span>, s:[phoenix.Vector](../../api/phoenix/Vector.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
