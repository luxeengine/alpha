...
<h1>TextureCoord</h1>
<small>`phoenix.geometry.TextureCoord` defined in ``</small>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_u:[Float](http://api.haxe.org/Float.html)<span></span>, \_v:[Float](http://api.haxe.org/Float.html)<span></span>, \_w:[Float](http://api.haxe.org/Float.html)<span></span>, \_t:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="set"><a class="lift" href="#set">set</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">set(\_u:[Float](http://api.haxe.org/Float.html)<span></span>, \_v:[Float](http://api.haxe.org/Float.html)<span></span>, \_w:[Float](http://api.haxe.org/Float.html)<span></span>, \_t:[Float](http://api.haxe.org/Float.html)<span></span>) : [phoenix.geometry.TextureCoord](../../../api/phoenix/geometry/TextureCoord.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="set_uv"><a class="lift" href="#set_uv">set\_uv</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">set\_uv(\_u:[Float](http://api.haxe.org/Float.html)<span></span>, \_v:[Float](http://api.haxe.org/Float.html)<span></span>) : [phoenix.geometry.TextureCoord](../../../api/phoenix/geometry/TextureCoord.html)</code><br/><span class="small_desc_flat"></span>
