...
`class`extends <code><span>phoenix.geometry.RingGeometry</span></code><br/><span class="meta">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(options:[luxe.options.CircleGeometryOptions](../../../api/luxe/options/CircleGeometryOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="set"><a class="lift" href="#set">set</a></a><a data-tooltip="inherited from <a href='../../../api/phoenix/geometry/RingGeometry.html#set'>phoenix.geometry.RingGeometry</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">set(\_x:[Float](http://api.haxe.org/Float.html)<span></span>, \_y:[Float](http://api.haxe.org/Float.html)<span></span>, \_rx:[Float](http://api.haxe.org/Float.html)<span></span>, \_ry:[Float](http://api.haxe.org/Float.html)<span></span>, \_steps:[Int](http://api.haxe.org/Int.html)<span></span>, \_start\_angle\_degrees:[Float](http://api.haxe.org/Float.html)<span></span>, \_end\_angle\_degrees:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
