...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">unknown : [phoenix.geometry.EvTextGeometry](../../../../api/phoenix/geometry/EvTextGeometry.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="update_text"><a class="lift" href="#update_text">update\_text</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">update\_text : [phoenix.geometry.EvTextGeometry](../../../../api/phoenix/geometry/EvTextGeometry.html)</code><br/></span>
