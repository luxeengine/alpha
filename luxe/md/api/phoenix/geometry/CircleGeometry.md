...
<span class="method apipage">
            ...
            <code class="signature apipage">set(\_x:[Float](http://api.haxe.org/Float.html)<span></span>, \_y:[Float](http://api.haxe.org/Float.html)<span></span>, \_rx:[Float](http://api.haxe.org/Float.html)<span></span>, \_ry:[Float](http://api.haxe.org/Float.html)<span></span>, \_steps:[Int](http://api.haxe.org/Int.html)<span></span>, \_start\_angle:[Float](http://api.haxe.org/Float.html)<span></span>, \_end\_angle:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
