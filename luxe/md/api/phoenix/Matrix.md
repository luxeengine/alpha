...
<span class="method apipage">
            ...
            <code class="signature apipage">makeRotationFromEuler(\_v:[phoenix.Vector](../../api/phoenix/Vector.html)<span></span>, \_order:[phoenix.ComponentOrder](../../api/phoenix/ComponentOrder.html)<span>=0</span>) : [phoenix.Matrix](../../api/phoenix/Matrix.html)</code><br/><span class="small_desc_flat"></span>
