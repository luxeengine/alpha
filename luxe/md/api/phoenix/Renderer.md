...
<h1>Renderer</h1>
<small>
<code><a target="_blank" href="https:/github.com/underscorediscovery/luxe/blob/master/phoenix/Renderer.hx">phoenix.Renderer</a></code>
</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">default\_fbo : [snow.modules.opengl.GLFramebuffer](https://snowkit.github.io/snow/api/snow/modules/opengl/GLFramebuffer.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="default_rbo"><a class="lift" href="#default_rbo">default\_rbo</a></a><div class="clear"></div>
                <code class="signature apipage">default\_rbo : [snow.modules.opengl.GLRenderbuffer](https://snowkit.github.io/snow/api/snow/modules/opengl/GLRenderbuffer.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="font_asset"><a class="lift" href="#font_asset">font\_asset</a></a><div class="clear"></div>
                <code class="signature apipage">font\_asset : [snow.systems.assets.AssetImage](https://snowkit.github.io/snow/api/snow/systems/assets/AssetImage.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_core:[luxe.Engine](../../api/luxe/Engine.html)<span></span>, \_asset:[snow.systems.assets.AssetImage](https://snowkit.github.io/snow/api/snow/systems/assets/AssetImage.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
