...
<span class="method apipage">
            ...
            <code class="signature apipage">blend\_equation(\_equation:[phoenix.BlendEquation](../../api/phoenix/BlendEquation.html)<span>=32774</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="blend_mode"><a class="lift" href="#blend_mode">blend\_mode</a></a><div class="clear"></div>
            <code class="signature apipage">blend\_mode(\_src\_mode:[phoenix.BlendMode](../../api/phoenix/BlendMode.html)<span>=770</span>, \_dst\_mode:[phoenix.BlendMode](../../api/phoenix/BlendMode.html)<span>=771</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
