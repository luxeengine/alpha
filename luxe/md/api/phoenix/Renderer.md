...
<h1>Renderer</h1>
<small>`phoenix.Renderer` defined in ``</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">default\_fbo : [snow.modules.opengl.GLFramebuffer](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="default_rbo"><a class="lift" href="#default_rbo">default\_rbo</a></a><div class="clear"></div>
                <code class="signature apipage">default\_rbo : [snow.modules.opengl.GLRenderbuffer](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">font\_asset : [snow.systems.assets.AssetImage](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_core:[luxe.Core](../../api/luxe/Core.html)<span></span>, \_asset:[snow.systems.assets.AssetImage](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
