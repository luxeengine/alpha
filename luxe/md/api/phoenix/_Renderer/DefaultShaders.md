...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="textured"><a class="lift" href="#textured">textured</a></a><div class="clear"></div>
                <code class="signature apipage">textured : [phoenix._Renderer.DefaultShader](../../../api/phoenix/_Renderer/DefaultShader.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="plain"><a class="lift" href="#plain">plain</a></a><div class="clear"></div>
                <code class="signature apipage">plain : [phoenix._Renderer.DefaultShader](../../../api/phoenix/_Renderer/DefaultShader.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="bitmapfont"><a class="lift" href="#bitmapfont">bitmapfont</a></a><div class="clear"></div>
                <code class="signature apipage">bitmapfont : [phoenix._Renderer.DefaultShader](../../../api/phoenix/_Renderer/DefaultShader.html)</code><br/></span>
