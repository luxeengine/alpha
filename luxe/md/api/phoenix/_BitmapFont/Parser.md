...
<h1>Parser</h1>
<small>`phoenix._BitmapFont.Parser`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">parse(\_font\_data:[String](http://api.haxe.org/String.html)<span></span>) : [phoenix.FontInfo](../../../api/phoenix/FontInfo.html)</code><br/><span class="small_desc_flat"></span>
