...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">pages : [Array](http://api.haxe.org/Array.html)&lt;[](#)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">kernings : [Map](http://api.haxe.org/Map.html)&lt;[Int](http://api.haxe.org/Int.html), [Map](http://api.haxe.org/Map.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="face"><a class="lift" href="#face">face</a></a><div class="clear"></div>
                <code class="signature apipage">face : [String](http://api.haxe.org/String.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="chars"><a class="lift" href="#chars">chars</a></a><div class="clear"></div>
                <code class="signature apipage">chars : [Map](http://api.haxe.org/Map.html)&lt;[Int](http://api.haxe.org/Int.html), [phoenix._BitmapFont.Character](../../api/phoenix/_BitmapFont/Character.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="char_count"><a class="lift" href="#char_count">char\_count</a></a><div class="clear"></div>
                <code class="signature apipage">char\_count : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="base_size"><a class="lift" href="#base_size">base\_size</a></a><div class="clear"></div>
                <code class="signature apipage">base\_size : [Float](http://api.haxe.org/Float.html)</code><br/></span>
