...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="fovx_to_y"><a class="lift" href="#fovx_to_y">fovx\_to\_y</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">fovx\_to\_y(fovx:[Float](http://api.haxe.org/Float.html)<span></span>, aspect:[Float](http://api.haxe.org/Float.html)<span></span>) : [Float](http://api.haxe.org/Float.html)</code><br/><span class="small_desc_flat"></span>
