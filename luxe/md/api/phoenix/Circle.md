...
<span class="method apipage">
            ...
            <code class="signature apipage">set(\_x:[Float](http://api.haxe.org/Float.html)<span></span>, \_y:[Float](http://api.haxe.org/Float.html)<span></span>, \_r:[Float](http://api.haxe.org/Float.html)<span></span>) : [phoenix.Circle](../../api/phoenix/Circle.html)</code><br/><span class="small_desc_flat"></span>
