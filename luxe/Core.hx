...
//gamepad
    ...
    override function get_runtime_config() : Dynamic {

       return game.get_runtime_config();

    } //get_runtime_config

        /** return what the game decides for window config */
    override function get_window_config() : WindowConfig {

        return game.get_window_config();
    ...
    override function get_asset_list() : Array<AssetInfo> {

        return game.get_asset_list();
