...
class Maths {
	...
	static public function clamp_bottom(value:Float, a:Float) : Float {
	...
	static public function map_linear( value:Float, a1:Float, a2:Float, b1:Float, b2:Float ) : Float {
	...
	static public function random_int( low:Int, high:Int ) : Int {
		return low + Math.floor(Math.random() * (high - low + 1));
	} //random_int
	
	static public function random_float( low:Float, high:Float ) : Float {
		return low + Math.random() * (high - low);
	} //random_float
	
	static public function random_float_spread( range:Float ) : Float {
