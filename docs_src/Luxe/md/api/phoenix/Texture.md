...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="texture"><a class="lift" href="#texture">texture</a></a><div class="clear"></div><code class="signature apipage">texture : [snow.render.opengl.GLTexture](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="asset"><a class="lift" href="#asset">asset</a></a><div class="clear"></div><code class="signature apipage">asset : [snow.assets.AssetImage](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
    ...
    <span class="method apipage">
            <a name="check_size"><a class="lift" href="#check_size">check\_size</a></a> <div class="clear"></div><code class="signature apipage">check\_size() : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
    ...
    <span class="method apipage">
            <a name="from_asset"><a class="lift" href="#from_asset">from\_asset</a></a> <div class="clear"></div><code class="signature apipage">from\_asset(\_asset:[snow.assets.AssetImage](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
    ...
    <span class="method apipage">
            <a name="activate"><a class="lift" href="#activate">activate</a></a> <div class="clear"></div><code class="signature apipage">activate(att:[snow.render.opengl.GLUniformLocation](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
    ...
    <span class="method apipage">
            <a name="_set_clamp"><a class="lift" href="#_set_clamp">\_set\_clamp</a></a> <div class="clear"></div><code class="signature apipage">\_set\_clamp(\_clamp:[phoenix.ClampType](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="set_clamp"><a class="lift" href="#set_clamp">set\_clamp</a></a> <div class="clear"></div><code class="signature apipage">set\_clamp(\_clamp:[phoenix.ClampType](#)<span></span>) : [phoenix.ClampType](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="_set_filter"><a class="lift" href="#_set_filter">\_set\_filter</a></a> <div class="clear"></div><code class="signature apipage">\_set\_filter(\_filter:[phoenix.FilterType](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="_set_filter_min"><a class="lift" href="#_set_filter_min">\_set\_filter\_min</a></a> <div class="clear"></div><code class="signature apipage">\_set\_filter\_min(\_filter:[phoenix.FilterType](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="_set_filter_mag"><a class="lift" href="#_set_filter_mag">\_set\_filter\_mag</a></a> <div class="clear"></div><code class="signature apipage">\_set\_filter\_mag(\_filter:[phoenix.FilterType](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="set_filter"><a class="lift" href="#set_filter">set\_filter</a></a> <div class="clear"></div><code class="signature apipage">set\_filter(\_filter:[phoenix.FilterType](#)<span></span>) : [phoenix.FilterType](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="set_filter_min"><a class="lift" href="#set_filter_min">set\_filter\_min</a></a> <div class="clear"></div><code class="signature apipage">set\_filter\_min(\_filter:[phoenix.FilterType](#)<span></span>) : [phoenix.FilterType](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="set_filter_mag"><a class="lift" href="#set_filter_mag">set\_filter\_mag</a></a> <div class="clear"></div><code class="signature apipage">set\_filter\_mag(\_filter:[phoenix.FilterType](#)<span></span>) : [phoenix.FilterType](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
    ...
    <span class="method apipage">
            <a name="load"><a class="lift" href="#load">load</a></a> <span class="inline-block static">static</span><div class="clear"></div><code class="signature apipage">load(\_id:[String](#)<span></span>, \_onloaded:[phoenix.Texture](#)&nbsp;-&gt; [Void](#)<span>=null</span>, \_silent:[Bool](#)<span>=false</span>) : [Null](#)&lt;[phoenix.Texture](#)&gt;</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="load_from_resource"><a class="lift" href="#load_from_resource">load\_from\_resource</a></a> <span class="inline-block static">static</span><div class="clear"></div><code class="signature apipage">load\_from\_resource(\_name:[String](#)<span></span>, \_width:[Int](#)<span></span>, \_height:[Int](#)<span></span>, \_cache:[Bool](#)<span>=true</span>) : [phoenix.Texture](#)</code><br/><span class="small_desc_flat"></span>
        </span>
