...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="texture_name"><a class="lift" href="#texture_name">texture\_name</a></a><div class="clear"></div><code class="signature apipage">texture\_name : [String](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="first_id"><a class="lift" href="#first_id">first\_id</a></a><div class="clear"></div><code class="signature apipage">first\_id : [Int](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="margin"><a class="lift" href="#margin">margin</a></a><div class="clear"></div><code class="signature apipage">margin : [Int](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="spacing"><a class="lift" href="#spacing">spacing</a></a><div class="clear"></div><code class="signature apipage">spacing : [Int](#)</code><br/></span>
            <span class="small_desc_flat"></span><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="property_tiles"><a class="lift" href="#property_tiles">property\_tiles</a></a><div class="clear"></div><code class="signature apipage">property\_tiles : [Map](#)&lt;[Int](#), [luxe.tilemaps.tiled.TiledPropertyTile](#)&gt;</code><br/></span>
