...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><code class="signature apipage">new(\_id:Int<span></span>, \_properties:Map<span></span>) : Void</code><br/><span class="small_desc_flat"></span>
        </span>
