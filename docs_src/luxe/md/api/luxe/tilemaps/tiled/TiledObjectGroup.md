...
<h3>Members</h3> <hr/><span class="member apipage">
            <a name="color"><a class="lift" href="#color">color</a></a><code class="signature apipage">color : [String](http://api.haxe.org/String.html)</code><br/></span>
        ...
        <span class="small_desc_flat"></span><span class="member apipage">
            <a name="objects"><a class="lift" href="#objects">objects</a></a><code class="signature apipage">objects : [Array](http://api.haxe.org/Array.html)&lt;[luxe.tilemaps.tiled.TiledObject](#luxe.tilemaps.tiled.TiledObject)&gt;</code><br/></span>
        <span class="small_desc_flat"></span><span class="member apipage">
