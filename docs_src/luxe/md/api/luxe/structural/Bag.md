...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><span class="member apipage">
                <a name="empty"><a class="lift" href="#empty">empty</a></a><code class="signature apipage">empty : [Bool](#)</code><br/></span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
    ...
    <span class="method apipage">
            <a name="add"><a class="lift" href="#add">add</a></a><code class="signature apipage">add(item:luxe.structural.Bag.T<span></span>) : Void</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
