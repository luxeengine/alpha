...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="mesh"><a class="lift" href="#mesh">mesh</a></a><div class="clear"></div><code class="signature apipage">mesh : [luxe.Mesh](#)</code><br/></span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
    ...
    <span class="method apipage">
            <a name="entity_pos_change"><a class="lift" href="#entity_pos_change">entity\_pos\_change</a></a> <div class="clear"></div><code class="signature apipage">entity\_pos\_change(\_pos:[luxe.Vector](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="entity_rotation_change"><a class="lift" href="#entity_rotation_change">entity\_rotation\_change</a></a> <div class="clear"></div><code class="signature apipage">entity\_rotation\_change(\_rotation:[luxe.Quaternion](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
