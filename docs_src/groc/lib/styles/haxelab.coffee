...
module.exports = class haxelab extends Base
  STATIC_ASSETS: ['style.css']

  constructor: (args...) ->
    super(args...)

    @sourceAssets = path.join __dirname, 'haxelab'
  ...
  renderCompleted: (callback) ->
    @log.trace 'styles.haxelab#renderCompleted(...)'
  ...
  copyAssets: (callback) ->
    @log.trace 'styles.haxelab#copyAssets(...)'
  ...
  compileScript: (callback) ->
    @log.trace 'styles.haxelab#compileScript(...)'
  ...
  compressScript: (scriptSource, callback) ->
    @log.trace 'styles.haxelab#compressScript(..., ...)'
  ...
  concatenateScripts: (scriptSource, callback) ->
    @log.trace 'styles.haxelab#concatenateScripts(..., ...)'
