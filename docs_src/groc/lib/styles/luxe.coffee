...
module.exports = class luxe extends Base
  STATIC_ASSETS: ['style.css']

  constructor: (args...) ->
    super(args...)

    @sourceAssets = path.join __dirname, 'luxe'
  ...
  renderCompleted: (callback) ->
    @log.trace 'styles.luxe#renderCompleted(...)'
  ...
  copyAssets: (callback) ->
    @log.trace 'styles.luxe#copyAssets(...)'
  ...
  compileScript: (callback) ->
    @log.trace 'styles.luxe#compileScript(...)'
  ...
  compressScript: (scriptSource, callback) ->
    @log.trace 'styles.luxe#compressScript(..., ...)'
  ...
  concatenateScripts: (scriptSource, callback) ->
    @log.trace 'styles.luxe#concatenateScripts(..., ...)'
