...
class Draw {
    ...
    private function default_options(options:Dynamic) {
        ...
        options.font = (options.font == null) ? Lab.renderer.default_font : options.font;
        ...
        options.batcher = (options.batcher == null)  ? Lab.renderer.default_batcher : options.batcher;
