...
import lab.utils.CompressionAlgorithm;
import lab.utils.IDataInput;
...
class ByteArray extends Bytes #if !haxe3 , #end implements ArrayAccess<Int> #if !haxe3 , #end implements IDataInput #if !haxe3 , #end implements IMemoryRange 
{
   ...
   /** @private */ static function __init__() {
      ...
      var init = Core.load("nme", "nme_byte_array_init", 4);
   ...
   // Native Methods
   /** @private */ private static var _double_bytes =    Core.load("std", "double_bytes", 2);
   /** @private */ private static var _double_of_bytes = Core.load("std", "double_of_bytes", 2);
   /** @private */ private static var _float_bytes =     Core.load("std", "float_bytes", 2);
   /** @private */ private static var _float_of_bytes =  Core.load("std", "float_of_bytes", 2);
   #if !no_nme_io
   private static var nme_byte_array_overwrite_file =    Core.load("nme","nme_byte_array_overwrite_file", 2);
   private static var nme_byte_array_read_file =         Core.load("nme", "nme_byte_array_read_file", 1);
   #end
   private static var nme_lzma_encode = Core.load("nme", "nme_lzma_encode", 1);
   private static var nme_lzma_decode = Core.load("nme", "nme_lzma_decode", 1);
}
